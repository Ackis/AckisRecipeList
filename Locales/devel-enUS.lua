...
L["MODULE_ERROR_FORMAT"] = "The \"Ackis Recipe List: %s\" module is not loaded. Either it is not installed or is disabled."
L["Mack Diver"] = true
L["Madame Ruby"] = true
L["Magar"] = true
L["Mageslayer"] = true
