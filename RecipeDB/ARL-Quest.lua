...
function addon:InitQuest(QuestDB)
	...
	self:addLookupList(QuestDB,429,L["Wild Hearts"],BZONE["Silverpine Forest"],43.60,41.01,0)
	self:addLookupList(QuestDB,471,L["Apprentice's Duties"],BZONE["Wetlands"],8.927,56.07,1)
	self:addLookupList(QuestDB,498,L["The Rescue"],BZONE["Hillsbrad Foothills"],63.15,20.31,0)
	...
	self:addLookupList(QuestDB,862,L["Dig Rat Stew"],BZONE["The Barrens"],54.98,31.97,0)
	self:addLookupList(QuestDB,1487,L["Deviate Eradication"],L["Unknown Zone"],0,0,0)
	...
	self:addLookupList(QuestDB,2751,L["Barbaric Battlements"],BZONE["Orgrimmar"],79.18,22.28,0)
	self:addLookupList(QuestDB,2752,L["On Iron Pauldrons"],BZONE["Orgrimmar"],79.18,22.28,0)
	self:addLookupList(QuestDB,2753,L["Trampled Under Foot"],BZONE["Orgrimmar"],79.18,22.28,0)
	self:addLookupList(QuestDB,2754,L["Horns of Frenzy"],BZONE["Orgrimmar"],79.18,22.28,0)
	self:addLookupList(QuestDB,2755,L["Joys of Omosh"],BZONE["Orgrimmar"],79.18,22.28,0)
	self:addLookupList(QuestDB,2756,L["The Old Ways"],BZONE["Orgrimmar"],80.12,24.76,2)
	self:addLookupList(QuestDB,2758,L["The Origins of Smithing"],BZONE["Stormwind City"],63.51,36.62,1)
	...
	self:addLookupList(QuestDB,3402,L["The Undermarket"],BZONE["Tanaris"],50.98,27.10,2)
	...
	self:addLookupList(QuestDB,5305,L["Sweet Serenity"],BZONE["Winterspring"],61.20,35.96,2)
	...
	self:addLookupList(QuestDB,8586,L["Dirge's Kickin' Chimaerok Chops"],BZONE["Tanaris"],52.50,28.00,2)
	...
	self:addLookupList(QuestDB,9454,L["The Great Moongraze Hunt"],BZONE["Bloodmyst Isle"],53.74,54.95,1)
