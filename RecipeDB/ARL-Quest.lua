...
function addon:InitQuest(QuestDB)
	...
	self:addLookupList(QuestDB,429,L["Wild Hearts"],BZONE["Silverpine Forest"],43.56,41.14,2) -- B/E
	...
	self:addLookupList(QuestDB,1618,L["Gearing Redridge"],BZONE["Ironforge"],31.37,47.34,1)  -- B/E
	...
	self:addLookupList(QuestDB,7321,L["Soothing Turtle Bisque"],BZONE["Hillsbrad Foothills"],62.30,19.02,2)
