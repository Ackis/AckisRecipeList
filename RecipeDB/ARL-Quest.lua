...
function addon:InitQuest(QuestDB)
	...
	self:addLookupList(QuestDB,8878,L["Festive Recipes"],BZONE["Moonglade"],53.8,35.5,0)
	self:addLookupList(QuestDB,8882,L["Cluster Launcher"],BZONE["Moonglade"],53.8,35.5,0)
