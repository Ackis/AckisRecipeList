...
function addon:InitQuest(QuestDB)
	...
	self:addLookupList(QuestDB,92,L["Redridge Goulash"],BZONE["Redridge Mountains"],23.06,44.351)
	...
	self:addLookupList(QuestDB,501,L["Elixir of Pain"],L["Unknown Zone"],0,00)
