...
function addon:InitEngineering(RecipeDB)
	...
	AddRecipe(3923,30,4360,1,0,30,60,75,90)
	...
	-- Copper Tube -- 3924
	AddRecipe(3924,50,4361,1,0,50,80,95,110)
	...
	AddRecipe(3925,50,4362,1,0,50,80,95,110)
	self:addTradeFlags(RecipeDB,3925,1,2,3,36,41)
	self:addTradeAcquire(RecipeDB,3925,1,1702,1,3290,1,3494,1,5174,1,5518,1,8736,1,11017,1,11025,
	1,11031,1,11037,1,16726,1,17222,1,17634,1,17637,1,18752,1,18775,1,19576,1,16667,1,28697,
	1,33586,1,26991,1,33611,1,33634,1,1676,1,25277,1,26907,1,26955)

	-- Copper Modulator -- 3926
	AddRecipe(3926,65,4363,1,0,65,95,110,125)
	...
	AddRecipe(3930,75,8068,1,0,75,85,90,95)
	...
	AddRecipe(3931,75,4365,1,0,75,90,97,105)
	...
	-- Target Dummy -- 3932
	AddRecipe(3932,85,4366,1,0,85,115,130,145)
	...
	AddRecipe(3936,105,4369,1,0,105,130,142,155)
	self:addTradeFlags(RecipeDB,3936,1,2,3,36,41)
	...
	AddRecipe(3937,105,4370,1,0,105,105,130,155)
	...
	-- Bronze Tube -- 3938
	AddRecipe(3938,105,4371,1,0,105,105,130,155)
	...
	AddRecipe(3939,120,4372,1,0,120,145,157,170)
	self:addTradeFlags(RecipeDB,3939,1,2,4,36,41)
	self:addTradeAcquire(RecipeDB,3939,2,2682,2,6730)

	-- Shadow Goggles -- 3940
	AddRecipe(3940,120,4373,2,0,120,145,157,170)
	self:addTradeFlags(RecipeDB,3940,1,2,10,36,40,56)
	self:addTradeAcquire(RecipeDB,3940,7,2)

	-- Small Bronze Bomb -- 3941
	AddRecipe(3941,120,4374,1,0,120,120,145,170)
	...
	AddRecipe(3942,125,4375,1,0,125,125,150,175)
	...
	-- Heavy Dynamite -- 3946
	AddRecipe(3946,125,4378,1,0,125,125,135,145)
	...
	AddRecipe(3947,125,8069,1,0,125,125,135,145)
	...
	AddRecipe(3949,130,4379,1,0,130,155,167,180)
	self:addTradeFlags(RecipeDB,3949,1,2,3,36,41)
	...
	AddRecipe(3950,140,4380,1,0,140,140,165,190)
	...
	AddRecipe(3952,140,4381,1,0,140,165,177,190)
	self:addTradeFlags(RecipeDB,3952,1,2,4,36,40,63)
	self:addTradeAcquire(RecipeDB,3952,2,2682,2,3495,2,2683)

	-- Bronze Framework -- 3953
	AddRecipe(3953,145,4382,1,0,145,145,170,195)
	...
	AddRecipe(3954,145,4383,2,0,145,170,182,195)
	self:addTradeFlags(RecipeDB,3954,1,2,10,36,40)
	self:addTradeAcquire(RecipeDB,3954,7,2)

	-- Explosive Sheep -- 3955
	AddRecipe(3955,150,4384,1,0,150,175,187,200)
	...
	AddRecipe(3956,150,4385,1,0,150,175,187,200)
	...
	-- Ice Deflector -- 3957
	AddRecipe(3957,155,4386,1,0,155,175,185,195)
	self:addTradeFlags(RecipeDB,3957,1,2,4,36,41)
	self:addTradeAcquire(RecipeDB,3957,2,2684)

	-- Iron Strut -- 3958
	AddRecipe(3958,160,4387,1,0,160,160,170,180)
	...
	-- Iron Grenade -- 3962
	AddRecipe(3962,175,4390,1,0,175,175,195,215)
	...
	AddRecipe(3963,175,4391,1,0,175,175,195,215)
	...
	AddRecipe(3965,185,4392,1,0,185,185,205,225)
	...
	AddRecipe(3966,185,4393,3,0,185,205,215,225)
	self:addTradeFlags(RecipeDB,3966,1,2,10,36,40,56)
	self:addTradeAcquire(RecipeDB,3966,7,3)

	-- Big Iron Bomb -- 3967
	AddRecipe(3967,190,4394,1,0,190,190,210,230)
	...
	AddRecipe(3972,200,4398,2,0,200,200,220,240)
	self:addTradeFlags(RecipeDB,3972,1,2,10,36,40)
	self:addTradeAcquire(RecipeDB,3972,7,2)

	-- Silver Contact -- 3973
	AddRecipe(3973,90,4404,1,0,90,110,125,140)
	...
	-- Crude Scope -- 3977
	AddRecipe(3977,60,4405,1,0,60,90,105,120)
	...
	-- Standard Scope -- 3978
	AddRecipe(3978,110,4406,1,0,110,135,147,160)
	...
	AddRecipe(7430,50,6219,1,0,50,70,80,90)
	...
	AddRecipe(9269,125,7506,1,0,125,150,162,175)
	...
	AddRecipe(9271,150,6533,1,0,150,150,160,170)
	...
	AddRecipe(9273,165,7148,1,0,165,165,180,200)
	...
	AddRecipe(12584,150,10558,1,0,150,150,170,190)
	...
	AddRecipe(12585,175,10505,1,0,175,175,185,195)
	...
	AddRecipe(12586,175,10507,1,0,175,175,185,195)
	...
	AddRecipe(12587,175,10499,2,0,175,195,205,215)
	self:addTradeFlags(RecipeDB,12587,1,2,10,36,40,56)
	self:addTradeAcquire(RecipeDB,12587,7,2)

	-- Mithril Tube -- 12589
	AddRecipe(12589,195,10559,1,0,195,195,215,235)
	...
	AddRecipe(12590,175,10498,1,0,175,175,195,215)
	...
	AddRecipe(12591,200,10560,1,0,200,200,220,240)
	...
	-- Fire Goggles -- 12594
	AddRecipe(12594,205,10500,1,0,205,225,235,245)
	...
	AddRecipe(12595,205,10508,1,0,205,225,235,245)
	...
	AddRecipe(12596,210,10512,1,0,210,210,230,250)
	...
	AddRecipe(12603,215,10514,1,0,215,215,235,255)
	...
	AddRecipe(12619,235,10562,1,0,235,235,255,275)
	...
	-- Green Lens -- 12622
	AddRecipe(12622,245,10504,1,0,245,265,275,285)
	...
	AddRecipe(12624,250,10576,1,0,250,270,280,290)
	...
	AddRecipe(12715,205,10644,1,0,205,205,205,205,20222)
	self:addTradeFlags(RecipeDB,12715,1,2,3,36,41)
	self:addTradeAcquire(RecipeDB,12715,1,8126,1,29513)

	-- Goblin Mortar -- 12716
	AddRecipe(12716,205,10577,1,0,205,225,235,245,20222)
	self:addTradeFlags(RecipeDB,12716,1,2,3,36,41,63)
	self:addTradeAcquire(RecipeDB,12716,1,8126,1,8738,1,29513)

	-- Goblin Mining Helmet -- 12717
	AddRecipe(12717,205,10542,1,0,205,225,235,245,20222)
	...
	AddRecipe(12755,230,10587,1,0,230,230,250,270,20222)
	...
	AddRecipe(12758,245,10588,1,0,245,265,275,285,20222)
	...
	AddRecipe(12759,240,10645,1,0,240,260,270,280,20219)
	...
	AddRecipe(12760,205,10646,1,0,205,205,225,245,20222)
	...
	AddRecipe(12895,205,10713,1,0,205,205,205,205,20219)
	...
	AddRecipe(12897,210,10545,1,0,210,230,240,250,20219)
	...
	AddRecipe(12899,205,10716,1,0,205,225,235,245,20219)
	...
	AddRecipe(12902,210,10720,1,0,210,230,240,250,20219)
	...
	AddRecipe(12903,215,10721,1,0,215,235,245,255,20219)
	...
	AddRecipe(12905,225,10724,1,0,225,245,255,265,20219)
	...
	AddRecipe(12906,230,10725,1,0,230,250,260,270,20219)
	...
	AddRecipe(12907,235,10726,1,0,235,255,265,275,20219)
	self:addTradeFlags(RecipeDB,12907,1,2,3,36,41,56)
	self:addTradeAcquire(RecipeDB,12907,1,7406,1,7944,1,29514)

	-- Goblin Dragon Gun -- 12908
	AddRecipe(12908,240,10727,1,0,240,260,270,280,20222)
	self:addTradeFlags(RecipeDB,12908,1,2,3,37,41,63)
	self:addTradeAcquire(RecipeDB,12908,1,8126,1,8738,1,29513)

	-- The Mortar: Reloaded -- 13240
	AddRecipe(13240,205,10577,1,0,205,205,205,205,20222)
	self:addTradeFlags(RecipeDB,13240,3,36,41,63)
	self:addTradeAcquire(RecipeDB,13240,1,8126,1,8738)

	-- Mechanical Repair Kit -- 15255
	AddRecipe(15255,200,11590,1,0,200,200,220,240)
	...
	AddRecipe(19788,250,15992,1,0,250,250,255,260)
	...
	AddRecipe(19790,260,15993,1,0,260,280,290,300)
	...
	AddRecipe(19791,260,15994,1,0,260,280,290,300)
	...
	-- Thorium Rifle -- 19792
	AddRecipe(19792,260,15995,2,0,260,280,290,300)
	...
	AddRecipe(19793,265,15996,2,0,265,285,295,305)
	...
	AddRecipe(19794,270,15999,2,0,270,290,300,310)
	self:addTradeFlags(RecipeDB,19794,1,2,3,36,40,56)
	...
	-- Thorium Tube -- 19795
	AddRecipe(19795,275,16000,1,0,275,295,305,315)
	...
	AddRecipe(19796,275,16004,2,0,275,295,305,315)
	self:addTradeFlags(RecipeDB,19796,1,2,5,36,40,63)
	self:addTradeAcquire(RecipeDB,19796,3,8897)

	-- Dark Iron Bomb -- 19799
	AddRecipe(19799,285,16005,2,0,285,305,315,325)
	self:addTradeFlags(RecipeDB,19799,1,2,5,11,36,40)
	self:addTradeAcquire(RecipeDB,19799,3,8920)

	-- Thorium Shells -- 19800
	AddRecipe(19800,285,15997,2,0,285,295,300,305)
	...
	AddRecipe(19814,275,16023,1,0,275,295,305,315)
	...
	AddRecipe(19815,285,16006,1,0,285,305,315,325)
	...
	AddRecipe(23071,260,18631,1,0,260,270,275,280)
	...
	AddRecipe(23081,290,18638,2,0,290,310,320,330)
	...
	AddRecipe(24357,300,19998,1,0,300,320,330,340)
	...
	AddRecipe(26426,275,21714,2,0,275,275,280,285)
	...
	AddRecipe(26427,275,21716,2,0,275,275,280,285)
	...
	AddRecipe(26443,275,21570,2,0,275,295,305,315)
	...
	AddRecipe(28327,275,22728,1,0,325,325,330,335)
	...
	self:addTradeFlags(RecipeDB,30313,1,2,4,36,40,63)
	...
	self:addTradeFlags(RecipeDB,30314,1,2,11,36,41,63)
	...
	self:addTradeFlags(RecipeDB,30563,1,2,3,36,41,63)
	...
	self:addTradeFlags(RecipeDB,30569,1,2,3,36,41,63)
	...
	self:addTradeFlags(RecipeDB,30574,1,2,3,37,41,56)
	...
	self:addTradeFlags(RecipeDB,40274,1,2,3, F_PALADIN, F_WARRIOR,37,41,59)
	...
	self:addTradeFlags(RecipeDB,56470,1,2,3,36,41)
	...
	self:addTradeFlags(RecipeDB,56473,1,2,3,36,41,63)
