...
function addon:InitEnchanting(RecipeDB)
	...
	self:addTradeSkill(RecipeDB,7745,100,nil,1,7411)
	...
	self:addTradeSkill(RecipeDB,13695,200,nil,1,7411)
	...
	self:addTradeAcquire(RecipeDB,27958,1,18753,1,18773,1,19540,1,28693)
	...
	self:addTradeSkill(RecipeDB,60663,420,nil,1,7411,2,420,430,440,450)
	...
	self:addTradeSkill(RecipeDB,60668,425,nil,1,7411,2,425,435,445,455)
	...
	self:addTradeSkill(RecipeDB,60691,430,nil,3,7411,2,430,440,450,460)
	...
	self:addTradeSkill(RecipeDB,60692,440,nil,2,7411,2,440,450,460,470)
	...
	self:addTradeSkill(RecipeDB,60707,435,nil,3,7411,2,435,445,455,465)
	...
	self:addTradeSkill(RecipeDB,60714,435,nil,3,7411,435,445,455,465)
	...
	self:addTradeSkill(RecipeDB,60763,440,nil,2,7411,2,440,450,460,470)
	...
	self:addTradeSkill(RecipeDB,60767,440,nil,2,7411,2,440,450,460,470)
	...
	self:addTradeSkill(RecipeDB,62256,450,nil,2,7411,2,450,460,470,480)
	...
	self:addTradeSkill(RecipeDB,44588,410,nil,2,7411,2,410,435,445,455)
	...
	--self:addTradeSkill(RecipeDB,62257,440,nil,2,7411,2,450,460,470,480)
	...
	self:addTradeSkill(RecipeDB,62948,450,nil,3,7411,2,450,455,460,465)
	...
	self:addTradeSkill(RecipeDB,64441,450,nil,3,7411,2,450,455,460,465)
	...
	self:addTradeSkill(RecipeDB,64579,450,nil,3,7411,2,450,455,460,465)
