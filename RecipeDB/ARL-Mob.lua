...
function addon:InitMob(MobDB)
	...
	self:addLookupList(MobDB,2407,L["Hulking Mountain Lion"],BZONE["Hillsbrad Foothills"],38.96,23.54)
	...
	self:addLookupList(MobDB,5420,L["Glasshide Gazer"],BZONE["Tanaris"],51.16,51.28)
	self:addLookupList(MobDB,5422,L["Scorpid Hunter"],BZONE["Tanaris"],54.75,30.08)
	self:addLookupList(MobDB,5423,L["Scorpid Tail Lasher"],BZONE["Un'Goro Crater"],83.21,39.40)
	self:addLookupList(MobDB,5425,L["Starving Blisterpaw"],BZONE["Un'Goro Crater"],83.05,42.06)
	self:addLookupList(MobDB,5426,L["Blisterpaw Hyena"],BZONE["Tanaris"],52.33,46.29)
	self:addLookupList(MobDB,5460,L["Centipaar Sandreaver"],BZONE["Tanaris"],34.90,43.21)
	...
	self:addLookupList(MobDB,7372,L["Deadwind Warlock"],BZONE["Deadwind Pass"],61.29,72.60)
	...
	self:addLookupList(MobDB,7444,L["Shardtooth Bear"],BZONE["Winterspring"],42.24,38.83)
	...
	self:addLookupList(MobDB,7447,L["Fledgling Chillwind"],BZONE["Winterspring"],42.10,39.41)
	...
	self:addLookupList(MobDB,8550,L["Shadowmage"],BZONE["Eastern Plaguelands"],70.92,39.87)
	self:addLookupList(MobDB,8561,L["Mossflayer Shadowhunter"],BZONE["Eastern Plaguelands"],62.78,15.43)
	self:addLookupList(MobDB,8637,L["Dark Iron Watchman"],BZONE["Searing Gorge"],64.24,56.75)
	...
	self:addLookupList(MobDB,9447,L["Scarlet Warder"],BZONE["Eastern Plaguelands"],75.52,77.65)
	...
	self:addLookupList(MobDB,14454,BBOSS["The Windreaver"],BZONE["Silithus"],26.24,21.91)
	...
	self:addLookupList(MobDB,19952,L["Bloodmaul Geomancer"],BZONE["Blade's Edge Mountains"],45.13,73.73)
	...
	self:addLookupList(MobDB,20135,L["Sunfury Arch Mage"],BZONE["Netherstorm"],49.33,83.27)
	...
	self:addLookupList(MobDB,22016,L["Eclipsion Soldier"],BZONE["Shadowmoon Valley"],52.42,62.52)
	...
	self:addLookupList(MobDB,28379,L["Shattertusk Mammoth"],BZONE["Sholazar Basin"],46.91,32.62)
	...
	self:addLookupList(MobDB,31321,L["Skeletal Runesmith"],BZONE["Icecrown"],58.65,74.34)
	self:addLookupList(MobDB,31702,L["Frostbrood Spawn"],BZONE["Icecrown"],72.34,41.38)
	self:addLookupList(MobDB,32191,L["Azure Stalker"],BZONE["The Nexus"],0,0)
	self:addLookupList(MobDB,32289,L["Damned Apothecary"],BZONE["Icecrown"],49.07,34.09)
