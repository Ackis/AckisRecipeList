...
600 found from data mining.  0 ignored.
...
function addon:InitMob(MobDB)
	...
	self:addLookupList(MobDB,764,L["Swampwalker"],BZONE["Swamp of Sorrows"],26.78,38.34)
	...
	self:addLookupList(MobDB,2407,L["Hulking Mountain Lion"],BZONE["Hillsbrad Foothills"],39.02,23.48)
	...
	self:addLookupList(MobDB,5460,L["Centipaar Sandreaver"],BZONE["Tanaris"],34.89,43.23)
	...
	self:addLookupList(MobDB,10806,L["Ursius"],BZONE["Winterspring"],60.68,31.72)
	...
	self:addLookupList(MobDB,14454,BBOSS["The Windreaver"],BZONE["Silithus"],26.13,22.05)
	...
	self:addLookupList(MobDB,22148,L["Gordunni Head-Splitter"],BZONE["Nagrand"],76.68,37.83)
	...
	self:addLookupList(MobDB,27329,L["Onslaught Bloodhound"],BZONE["Dragonblight"],86.79,37.41)
	...
	self:addLookupList(MobDB,30208,L["Stormforged Ambusher"],BZONE["The Storm Peaks"],70.06,59.87)
