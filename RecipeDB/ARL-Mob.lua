...
function addon:InitMob(MobDB)
	...
	self:addLookupList(MobDB,772,L["Stranglethorn Tigress"],BZONE["Stranglethorn Vale"],41.37,33.57)
	...
	self:addLookupList(MobDB,10807,L["Brumeran"],BZONE["Winterspring"],60.75,56.96)
	...
	self:addLookupList(MobDB,30208,L["Stormforged Ambusher"],BZONE["The Storm Peaks"],70.08,59.77)
	...
	self:addLookupList(MobDB,31702,L["Frostbrood Spawn"],BZONE["Icecrown"],72.22,41.25)
	...
	self:addLookupList(MobDB,32349,L["Cultist Shard Watcher"],BZONE["Icecrown"],47.99,67.77)
