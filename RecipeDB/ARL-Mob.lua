...
function addon:InitMob(MobDB)
	...
	self:addLookupList(MobDB,8546,L["Dark Adept"],BZONE["Eastern Plaguelands"],67.32,36.96)
	self:addLookupList(MobDB,8550,L["Shadowmage"],BZONE["Eastern Plaguelands"],71.59,39.59)
	self:addLookupList(MobDB,8561,L["Mossflayer Shadowhunter"],BZONE["Eastern Plaguelands"],62.79,15.41)
	...
	self:addLookupList(MobDB,23282,L["Obsidia"],BZONE["Blade's Edge Mountains"],31.51,57.60)
	...
	self:addLookupList(MobDB,28379,L["Shattertusk Mammoth"],BZONE["Sholazar Basin"],46.58,32.39)
	...
	self:addLookupList(MobDB,29792,L["Frostfeather Screecher"],BZONE["The Storm Peaks"],30.79,69.41)
	...
	self:addLookupList(MobDB,31702,L["Frostbrood Spawn"],BZONE["Icecrown"],72.20,41.25)
