...
610 found from data mining.  0 ignored.
...
function addon:InitMob(MobDB)
	...
	self:addLookupList(MobDB,157,L["Goretusk"],BZONE["Westfall"],48.26,55.44)
	...
	self:addLookupList(MobDB,5426,L["Blisterpaw Hyena"],BZONE["Tanaris"],52.32,46.28)
	...
	self:addLookupList(MobDB,7158,L["Deadwood Shaman"],BZONE["Felwood"],62.73,9.533)
	...
	self:addLookupList(MobDB,24966,L["Wretched Fiend"],BZONE["Isle of Quel'Danas"],40.22,35.48)
