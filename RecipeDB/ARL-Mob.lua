...
603 found from data mining.  0 ignored.
...
function addon:InitMob(MobDB)
	...
	self:addLookupList(MobDB,1081,L["Mire Lord"],BZONE["Swamp of Sorrows"],7.515,32.08)
	...
	self:addLookupList(MobDB,1812,L["Rotting Behemoth"],BZONE["Western Plaguelands"],63.54,36.75)
	self:addLookupList(MobDB,1813,L["Decaying Horror"],BZONE["Western Plaguelands"],62.84,35.35)
	...
	self:addLookupList(MobDB,1844,L["Foreman Marcrid"],BZONE["Western Plaguelands"],46.36,33.88)
	...
	self:addLookupList(MobDB,2407,L["Hulking Mountain Lion"],BZONE["Hillsbrad Foothills"],39.12,23.45)
	...
	self:addLookupList(MobDB,2606,L["Nimar the Slayer"],BZONE["Arathi Highlands"],65.73,68.83)
	...
	self:addLookupList(MobDB,4143,L["Sparkleshell Snapper"],BZONE["Thousand Needles"],81.22,64.41)
	...
	self:addLookupList(MobDB,4834,L["Theramore Infiltrator"],BZONE["Dustwallow Marsh"],39.48,30.96)
	...
	self:addLookupList(MobDB,5460,L["Centipaar Sandreaver"],BZONE["Tanaris"],34.88,43.23)
	...
	self:addLookupList(MobDB,5853,L["Tempered War Golem"],BZONE["Searing Gorge"],64.16,56.75)
	...
	self:addLookupList(MobDB,6146,L["Cliff Breaker"],BZONE["Azshara"],60.35,59.26)
	self:addLookupList(MobDB,6201,L["Legashi Rogue"],BZONE["Azshara"],57.21,21.19)
	...
	self:addLookupList(MobDB,6556,L["Muculent Ooze"],BZONE["Un'Goro Crater"],68.38,34.37)
	...
	self:addLookupList(MobDB,7106,L["Jadefire Rogue"],BZONE["Darkshore"],46.31,85.11)
	...
	self:addLookupList(MobDB,7459,L["Ice Thistle Matriarch"],BZONE["Winterspring"],68.34,42.02)
	self:addLookupList(MobDB,7460,L["Ice Thistle Patriarch"],BZONE["Winterspring"],68.25,41.81)
	...
	self:addLookupList(MobDB,8546,L["Dark Adept"],BZONE["Eastern Plaguelands"],66.95,36.94)
	...
	self:addLookupList(MobDB,8637,L["Dark Iron Watchman"],BZONE["Searing Gorge"],64.27,56.68)
	...
	self:addLookupList(MobDB,10660,L["Cobalt Broodling"],BZONE["Winterspring"],57.89,51.76)
	self:addLookupList(MobDB,10661,L["Spell Eater"],BZONE["Winterspring"],57.70,51.74)
	self:addLookupList(MobDB,10662,L["Spellmaw"],BZONE["Winterspring"],59.23,51.08)
	...
	self:addLookupList(MobDB,14276,L["Scargil"],BZONE["Hillsbrad Foothills"],26.77,70.04)
	self:addLookupList(MobDB,14354,BBOSS["Pusillin"],BZONE["Dire Maul"],0,0)
	self:addLookupList(MobDB,14454,BBOSS["The Windreaver"],BZONE["Silithus"],26.15,22.08)
	...
	self:addLookupList(MobDB,18870,L["Voidshrieker"],BZONE["Netherstorm"],62.39,39.71)
	...
	self:addLookupList(MobDB,20135,L["Sunfury Arch Mage"],BZONE["Netherstorm"],49.33,83.26)
	...
	self:addLookupList(MobDB,22093,L["Illidari Watcher"],BZONE["Shadowmoon Valley"],52.70,72.05)
	...
	self:addLookupList(MobDB,23022,L["Gordunni Soulreaper"],BZONE["Nagrand"],76.05,36.96)
	...
	self:addLookupList(MobDB,23385,L["Simon Unit"],BZONE["Blade's Edge Mountains"],35.16,49.22)
	...
	self:addLookupList(MobDB,25073,L["Darkspine Siren"],BZONE["Isle of Quel'Danas"],61.57,56.15)
	...
	self:addLookupList(MobDB,30208,L["Stormforged Ambusher"],BZONE["The Storm Peaks"],70.07,59.87)
	...
	self:addLookupList(MobDB,32349,L["Cultist Shard Watcher"],BZONE["Icecrown"],48.02,67.81)
