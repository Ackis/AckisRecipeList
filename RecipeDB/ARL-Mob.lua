...
function addon:InitMob(MobDB)
	...
	self:addLookupList(MobDB,764,L["Swampwalker"],BZONE["Swamp of Sorrows"],26.66,38.36)
	...
	self:addLookupList(MobDB,1791,L["Slavering Ghoul"],BZONE["Western Plaguelands"],44.93,69.32)
	...
	self:addLookupList(MobDB,1822,L["Venom Mist Lurker"],BZONE["Tirisfal Glades"],84.48,71.51)
	...
	self:addLookupList(MobDB,2356,L["Elder Gray Bear"],BZONE["Arathi Highlands"],23.11,24.30)
	...
	self:addLookupList(MobDB,3825,L["Ghostpaw Alpha"],BZONE["Ashenvale"],67.92,55.60)
	...
	self:addLookupList(MobDB,4143,L["Sparkleshell Snapper"],BZONE["Thousand Needles"],81.23,64.84)
	self:addLookupList(MobDB,4147,L["Saltstone Basilisk"],BZONE["Thousand Needles"],75.09,60.97)
	...
	self:addLookupList(MobDB,5425,L["Starving Blisterpaw"],BZONE["Un'Goro Crater"],83.25,42.07)
	self:addLookupList(MobDB,5426,L["Blisterpaw Hyena"],BZONE["Tanaris"],52.36,46.31)
	self:addLookupList(MobDB,5460,L["Centipaar Sandreaver"],BZONE["Tanaris"],34.94,43.16)
	...
	self:addLookupList(MobDB,7027,L["Blackrock Slayer"],BZONE["Burning Steppes"],46.28,50.45)
	self:addLookupList(MobDB,7029,L["Blackrock Battlemaster"],BZONE["Burning Steppes"],40.94,34.76)
	self:addLookupList(MobDB,7035,L["Firegut Brute"],BZONE["Burning Steppes"],81.93,42.27)
	self:addLookupList(MobDB,7037,L["Thaurissan Firewalker"],BZONE["Burning Steppes"],62.88,39.36)
	self:addLookupList(MobDB,7040,L["Black Dragonspawn"],BZONE["Burning Steppes"],87.21,44.18)
	self:addLookupList(MobDB,7047,L["Black Broodling"],BZONE["Burning Steppes"],87.18,46.44)
	...
	self:addLookupList(MobDB,7443,L["Shardtooth Mauler"],BZONE["Winterspring"],60.76,34.52)
	self:addLookupList(MobDB,7444,L["Shardtooth Bear"],BZONE["Winterspring"],42.26,38.83)
	self:addLookupList(MobDB,7447,L["Fledgling Chillwind"],BZONE["Winterspring"],42.12,39.40)
	self:addLookupList(MobDB,7448,L["Chillwind Chimaera"],BZONE["Winterspring"],62.66,38.52)
	...
	self:addLookupList(MobDB,8546,L["Dark Adept"],BZONE["Eastern Plaguelands"],67.30,36.95)
	...
	self:addLookupList(MobDB,8961,L["Felpaw Ravager"],BZONE["Felwood"],57.95,19.02)
	...
	self:addLookupList(MobDB,9166,L["Pterrordax"],BZONE["Un'Goro Crater"],54.22,47.50)
	...
	self:addLookupList(MobDB,9447,L["Scarlet Warder"],BZONE["Eastern Plaguelands"],75.88,78.10)
	...
	self:addLookupList(MobDB,10119,L["Volchan"],BZONE["Burning Steppes"],82.57,47.50)
	...
	self:addLookupList(MobDB,14454,L["The Windreaver"],BZONE["Silithus"],26.32,21.91)
	self:addLookupList(MobDB,14457,L["Princess Tempestria"],BZONE["Winterspring"],53.50,42.59)
	...
	self:addLookupList(MobDB,18062,L["Enraged Crusher"],BZONE["Nagrand"],49.98,41.67)
	...
	self:addLookupList(MobDB,23282,L["Obsidia"],BZONE["Blade's Edge Mountains"],31.51,57.62)
	...
	self:addLookupList(MobDB,30921,L["Skeletal Runesmith"],BZONE["Icecrown"],58.70,73.94)
	...
	self:addLookupList(MobDB,32290,L["Cult Alchemist"],BZONE["Icecrown"],48.77,34.15)
