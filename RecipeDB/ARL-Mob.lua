...
574 found from data mining.  0 ignored.
...
function addon:InitMob(MobDB)
	...
	self:addLookupList(MobDB,1783,L["Skeletal Flayer"],BZONE["Western Plaguelands"],44.91,71.04)
	self:addLookupList(MobDB,1791,L["Slavering Ghoul"],BZONE["Western Plaguelands"],44.90,69.27)
	...
	self:addLookupList(MobDB,1844,L["Foreman Marcrid"],BZONE["Western Plaguelands"],46.46,33.93)
	...
	self:addLookupList(MobDB,2356,L["Elder Gray Bear"],BZONE["Arathi Highlands"],23.25,24.25)
	...
	self:addLookupList(MobDB,2407,L["Hulking Mountain Lion"],BZONE["Hillsbrad Foothills"],38.90,24.23)
	...
	self:addLookupList(MobDB,3825,L["Ghostpaw Alpha"],BZONE["Ashenvale"],67.93,55.67)
	...
	self:addLookupList(MobDB,5460,L["Centipaar Sandreaver"],BZONE["Tanaris"],34.98,43.07)
	...
	self:addLookupList(MobDB,5862,L["Twilight Geomancer"],BZONE["Searing Gorge"],24.58,29.03)
	self:addLookupList(MobDB,5990,L["Redstone Basilisk"],BZONE["Blasted Lands"],58.00,31.23)
	self:addLookupList(MobDB,5993,L["Helboar"],BZONE["Blasted Lands"],55.14,49.84)
	...
	self:addLookupList(MobDB,14454,L["The Windreaver"],BZONE["Silithus"],27.08,22.36)
	...
	self:addLookupList(MobDB,17150,L["Vir'aani Arcanist"],BZONE["Nagrand"],36.61,68.06)
	...
	self:addLookupList(MobDB,19740,L["Wrathwalker"],BZONE["Shadowmoon Valley"],24.20,34.55)
	...
	self:addLookupList(MobDB,19826,L["Dark Conclave Shadowmancer"],BZONE["Shadowmoon Valley"],37.33,31.74)
	self:addLookupList(MobDB,19952,L["Bloodmaul Geomancer"],BZONE["Blade's Edge Mountains"],45.14,73.61)
	...
	self:addLookupList(MobDB,22016,L["Eclipsion Soldier"],BZONE["Shadowmoon Valley"],52.36,62.32)
	...
	self:addLookupList(MobDB,27333,L["Onslaught Mason"],BZONE["Dragonblight"],85.01,39.84)
	...
	self:addLookupList(MobDB,27978,BBOSS["Sjonnir The Ironshaper"],BZONE["Sjonnir The Ironshaper"],0,0)
	...
	self:addLookupList(MobDB,29370,L["Stormforged Champion"],BZONE["The Storm Peaks"],25.01,46.62)
	self:addLookupList(MobDB,29376,L["Stormforged Artificer"],BZONE["The Storm Peaks"],30.10,46.34)
	self:addLookupList(MobDB,29402,L["Ironwool Mammoth"],BZONE["The Storm Peaks"],37.21,83.90)
	self:addLookupList(MobDB,29451,L["Vargul Slayer"],BZONE["Zul'Drak"],19.67,56.63)
	self:addLookupList(MobDB,29570,L["Nascent Val'kyr"],BZONE["Icecrown"],69.72,41.51)
	self:addLookupList(MobDB,29646,L["Banshee Soulclaimer"],BZONE["Zul'Drak"],24.96,59.91)
	self:addLookupList(MobDB,29792,L["Frostfeather Screecher"],BZONE["The Storm Peaks"],30.55,69.34)
	self:addLookupList(MobDB,29793,L["Frostfeather Witch"],BZONE["The Storm Peaks"],30.44,68.55)
