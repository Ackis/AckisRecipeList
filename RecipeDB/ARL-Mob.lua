...
function addon:InitMob(MobDB)
	...
	self:addLookupList(MobDB,590,L["Defias Looter"],BZONE["Westfall"],42.61,65.44)
	...
	self:addLookupList(MobDB,910,L["Defias Enchanter"],BZONE["Duskwood"],38.99,74.68)
	...
	self:addLookupList(MobDB,1017,L["Highland Scytheclaw"],BZONE["Wetlands"],47.38,24.11)
	...
	self:addLookupList(MobDB,1417,L["Young Wetlands Crocolisk"],BZONE["Wetlands"],36.40,44.52)
	...
	self:addLookupList(MobDB,2356,L["Elder Gray Bear"],BZONE["Arathi Highlands"],22.96,24.56)
	...
	self:addLookupList(MobDB,2407,L["Hulking Mountain Lion"],BZONE["Hillsbrad Foothills"],39.39,23.07)
	...
	self:addLookupList(MobDB,4143,L["Sparkleshell Snapper"],BZONE["Thousand Needles"],81.21,64.31)
	...
	self:addLookupList(MobDB,5425,L["Starving Blisterpaw"],BZONE["Un'Goro Crater"],83.04,42.90)
	...
	self:addLookupList(MobDB,5862,L["Twilight Geomancer"],BZONE["Searing Gorge"],24.47,29.16)
	...
	self:addLookupList(MobDB,7025,L["Blackrock Soldier"],BZONE["Burning Steppes"],47.32,54.46)
	self:addLookupList(MobDB,7027,L["Blackrock Slayer"],BZONE["Burning Steppes"],46.26,50.30)
	...
	self:addLookupList(MobDB,7445,L["Elder Shardtooth"],BZONE["Winterspring"],59.52,25.68)
	...
	self:addLookupList(MobDB,8959,L["Felpaw Wolf"],BZONE["Ashenvale"],55.60,29.13)
	...
	self:addLookupList(MobDB,13445,L["Great-father Winter"],BZONE["Orgrimmar"],52.75,68.16)
	...
	self:addLookupList(MobDB,26206,BBOSS["Keristrasza"],BZONE["Borean Tundra"],29.53,29.91)
	...
	self:addLookupList(MobDB,28380,L["Shattertusk Bull"],BZONE["Sholazar Basin"],53.04,30.13)
	...
	self:addLookupList(MobDB,29235,L["Gundrak Savage"],BZONE["Zul'Drak"],73.76,30.99)
	...
	self:addLookupList(MobDB,31702,L["Frostbrood Spawn"],BZONE["Icecrown"],72.40,41.44)
