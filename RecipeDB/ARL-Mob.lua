...
589 found from data mining.  0 ignored.
...
function addon:InitMob(MobDB)
	...
	self:addLookupList(MobDB,766,L["Tangled Horror"],BZONE["Swamp of Sorrows"],44.85,42.31)
	...
	self:addLookupList(MobDB,910,L["Defias Enchanter"],BZONE["Duskwood"],39.04,74.69)
	self:addLookupList(MobDB,923,L["Young Black Ravager"],BZONE["Duskwood"],48.59,64.48)
	self:addLookupList(MobDB,938,L["Kurzen Commando"],BZONE["Stranglethorn Vale"],46.65,7.986)
	self:addLookupList(MobDB,1015,L["Highland Raptor"],BZONE["Wetlands"],51.82,26.84)
	self:addLookupList(MobDB,1017,L["Highland Scytheclaw"],BZONE["Wetlands"],47.32,24.09)
	...
	self:addLookupList(MobDB,1081,L["Mire Lord"],BZONE["Swamp of Sorrows"],7.501,32.08)
	...
	self:addLookupList(MobDB,1417,L["Young Wetlands Crocolisk"],BZONE["Wetlands"],36.40,44.54)
	...
	self:addLookupList(MobDB,1844,L["Foreman Marcrid"],BZONE["Western Plaguelands"],46.45,33.85)
	...
	self:addLookupList(MobDB,2356,L["Elder Gray Bear"],BZONE["Arathi Highlands"],22.97,24.54)
	...
	self:addLookupList(MobDB,2407,L["Hulking Mountain Lion"],BZONE["Hillsbrad Foothills"],39.55,22.99)
	...
	self:addLookupList(MobDB,2606,L["Nimar the Slayer"],BZONE["Arathi Highlands"],65.78,68.82)
	...
	self:addLookupList(MobDB,2926,L["Silvermane Stalker"],BZONE["The Hinterlands"],63.75,54.50)
	...
	self:addLookupList(MobDB,3531,L["Moonrage Tailor"],BZONE["Silverpine Forest"],47.04,72.61)
	self:addLookupList(MobDB,3809,L["Ashenvale Bear"],BZONE["Ashenvale"],46.76,56.08)
	self:addLookupList(MobDB,3818,L["Elder Shadowhorn Stag"],BZONE["Ashenvale"],63.62,48.49)
	self:addLookupList(MobDB,3825,L["Ghostpaw Alpha"],BZONE["Ashenvale"],67.87,55.70)
	self:addLookupList(MobDB,3834,L["Crazed Ancient"],BZONE["Ashenvale"],58.38,38.75)
	self:addLookupList(MobDB,3919,L["Withered Ancient"],BZONE["Ashenvale"],58.40,38.88)
	self:addLookupList(MobDB,4028,L["Charred Ancient"],BZONE["Stonetalon Mountains"],33.99,66.76)
	self:addLookupList(MobDB,4029,L["Blackened Ancient"],BZONE["Stonetalon Mountains"],34.00,66.71)
	...
	self:addLookupList(MobDB,4117,L["Cloud Serpent"],BZONE["Thousand Needles"],43.03,48.87)
	...
	self:addLookupList(MobDB,4364,L["Strashaz Warrior"],BZONE["Dustwallow Marsh"],75.05,19.31)
	...
	self:addLookupList(MobDB,4674,L["Hatefury Shadowstalker"],BZONE["Desolace"],75.36,20.73)
	...
	self:addLookupList(MobDB,5425,L["Starving Blisterpaw"],BZONE["Un'Goro Crater"],83.06,42.93)
	self:addLookupList(MobDB,5426,L["Blisterpaw Hyena"],BZONE["Tanaris"],52.23,46.22)
	...
	self:addLookupList(MobDB,5853,L["Tempered War Golem"],BZONE["Searing Gorge"],64.33,55.93)
	self:addLookupList(MobDB,5860,L["Twilight Dark Shaman"],BZONE["Searing Gorge"],23.23,36.82)
	self:addLookupList(MobDB,5861,L["Twilight Fire Guard"],BZONE["Searing Gorge"],23.42,34.50)
	...
	self:addLookupList(MobDB,6005,L["Shadowsworn Thug"],BZONE["Blasted Lands"],64.81,35.69)
	self:addLookupList(MobDB,6138,L["Arkkoran Oracle"],BZONE["Azshara"],77.23,42.50)
	self:addLookupList(MobDB,6144,L["Son of Arkkoroc"],BZONE["Azshara"],60.65,53.30)
	self:addLookupList(MobDB,6146,L["Cliff Breaker"],BZONE["Azshara"],60.39,59.54)
	self:addLookupList(MobDB,6201,L["Legashi Rogue"],BZONE["Azshara"],57.27,21.23)
	...
	self:addLookupList(MobDB,7025,L["Blackrock Soldier"],BZONE["Burning Steppes"],47.33,54.47)
	self:addLookupList(MobDB,7027,L["Blackrock Slayer"],BZONE["Burning Steppes"],46.25,50.27)
	self:addLookupList(MobDB,7029,L["Blackrock Battlemaster"],BZONE["Burning Steppes"],40.95,34.77)
	self:addLookupList(MobDB,7035,L["Firegut Brute"],BZONE["Burning Steppes"],81.90,42.47)
	self:addLookupList(MobDB,7037,L["Thaurissan Firewalker"],BZONE["Burning Steppes"],62.94,39.33)
	self:addLookupList(MobDB,7040,L["Black Dragonspawn"],BZONE["Burning Steppes"],86.90,45.99)
	self:addLookupList(MobDB,7047,L["Black Broodling"],BZONE["Burning Steppes"],87.19,51.63)
	self:addLookupList(MobDB,7055,L["Blackrock Worg"],BZONE["Burning Steppes"],48.49,56.21)
	self:addLookupList(MobDB,7106,L["Jadefire Rogue"],BZONE["Darkshore"],46.37,85.23)
	self:addLookupList(MobDB,7109,L["Jadefire Felsworn"],BZONE["Darkshore"],46.42,84.63)
	...
	self:addLookupList(MobDB,7437,L["Cobalt Mageweaver"],BZONE["Winterspring"],57.87,51.84)
	self:addLookupList(MobDB,7438,L["Winterfall Ursa"],BZONE["Winterspring"],67.01,38.36)
	self:addLookupList(MobDB,7440,L["Winterfall Den Watcher"],BZONE["Winterspring"],52.20,38.48)
	...
	self:addLookupList(MobDB,7445,L["Elder Shardtooth"],BZONE["Winterspring"],59.53,25.71)
	...
	self:addLookupList(MobDB,7449,L["Chillwind Ravager"],BZONE["Winterspring"],59.35,26.60)
	...
	self:addLookupList(MobDB,8546,L["Dark Adept"],BZONE["Eastern Plaguelands"],66.86,36.90)
	self:addLookupList(MobDB,8550,L["Shadowmage"],BZONE["Eastern Plaguelands"],70.73,40.03)
	self:addLookupList(MobDB,8561,L["Mossflayer Shadowhunter"],BZONE["Eastern Plaguelands"],62.87,15.25)
	self:addLookupList(MobDB,8637,L["Dark Iron Watchman"],BZONE["Searing Gorge"],64.41,56.04)
	...
	self:addLookupList(MobDB,8957,L["Angerclaw Grizzly"],BZONE["Felwood"],56.76,18.10)
	...
	self:addLookupList(MobDB,9163,L["Diemetradon"],BZONE["Un'Goro Crater"],53.17,50.55)
	self:addLookupList(MobDB,9164,L["Elder Diemetradon"],BZONE["Un'Goro Crater"],36.12,49.14)
	self:addLookupList(MobDB,9166,L["Pterrordax"],BZONE["Un'Goro Crater"],54.19,47.69)
	...
	self:addLookupList(MobDB,9447,L["Scarlet Warder"],BZONE["Eastern Plaguelands"],75.05,77.27)
	...
	self:addLookupList(MobDB,9695,L["Deathlash Scorpid"],BZONE["Burning Steppes"],63.17,45.68)
	...
	self:addLookupList(MobDB,10119,L["Volchan"],BZONE["Burning Steppes"],82.56,48.45)
	...
	self:addLookupList(MobDB,10660,L["Cobalt Broodling"],BZONE["Winterspring"],57.86,51.86)
	self:addLookupList(MobDB,10661,L["Spell Eater"],BZONE["Winterspring"],57.66,51.72)
	...
	self:addLookupList(MobDB,13444,L["Greatfather Winter"],BZONE["Ironforge"],32.80,65.75)
	...
	self:addLookupList(MobDB,17150,L["Vir'aani Arcanist"],BZONE["Nagrand"],36.63,67.89)
	...
	self:addLookupList(MobDB,18062,L["Enraged Crusher"],BZONE["Nagrand"],50.06,41.34)
	...
	self:addLookupList(MobDB,19795,L["Eclipsion Blood Knight"],BZONE["Shadowmoon Valley"],52.02,61.22)
	self:addLookupList(MobDB,19796,L["Eclipsion Archmage"],BZONE["Shadowmoon Valley"],47.56,66.23)
	self:addLookupList(MobDB,19802,L["Illidari Shocktrooper"],BZONE["Shadowmoon Valley"],31.58,50.17)
	...
	self:addLookupList(MobDB,19952,L["Bloodmaul Geomancer"],BZONE["Blade's Edge Mountains"],45.11,73.75)
	self:addLookupList(MobDB,19960,L["Doomforge Engineer"],BZONE["Blade's Edge Mountains"],74.33,40.99)
	self:addLookupList(MobDB,19973,L["Abyssal Flamebringer"],BZONE["Blade's Edge Mountains"],29.23,79.94)
	self:addLookupList(MobDB,19984,L["Vekh'nir Dreadhawk"],BZONE["Blade's Edge Mountains"],73.94,74.53)
	...
	self:addLookupList(MobDB,20136,L["Sunfury Researcher"],BZONE["Netherstorm"],51.06,83.50)
	...
	self:addLookupList(MobDB,22822,L["Ethereum Nullifier"],BZONE["Netherstorm"],63.11,41.31)
	...
	self:addLookupList(MobDB,23385,L["Simon Unit"],BZONE["Blade's Edge Mountains"],34.88,49.69)
	...
	self:addLookupList(MobDB,25073,L["Darkspine Siren"],BZONE["Isle of Quel'Danas"],61.57,56.11)
	...
	self:addLookupList(MobDB,26206,BBOSS["Keristrasza"],BZONE["Borean Tundra"],29.56,29.95)
	...
	self:addLookupList(MobDB,28380,L["Shattertusk Bull"],BZONE["Sholazar Basin"],53.03,30.16)
	...
	self:addLookupList(MobDB,29235,L["Gundrak Savage"],BZONE["Zul'Drak"],73.79,30.91)
	...
	self:addLookupList(MobDB,29376,L["Stormforged Artificer"],BZONE["The Storm Peaks"],30.18,46.51)
	...
	self:addLookupList(MobDB,30208,L["Stormforged Ambusher"],BZONE["The Storm Peaks"],70.09,59.88)
	...
	self:addLookupList(MobDB,31702,L["Frostbrood Spawn"],BZONE["Icecrown"],72.40,41.48)
	...
	self:addLookupList(MobDB,32349,L["Cultist Shard Watcher"],BZONE["Icecrown"],48.05,67.82)
