...
602 found from data mining.  0 ignored.
...
function addon:InitMob(MobDB)
	...
	self:addLookupList(MobDB,764,L["Swampwalker"],BZONE["Swamp of Sorrows"],26.76,38.34)
	...
	self:addLookupList(MobDB,910,L["Defias Enchanter"],BZONE["Duskwood"],38.92,74.66)
	self:addLookupList(MobDB,923,L["Young Black Ravager"],BZONE["Duskwood"],48.55,64.53)
	...
	self:addLookupList(MobDB,1054,L["Dark Iron Demolitionist"],BZONE["Wetlands"],56.70,24.11)
	...
	self:addLookupList(MobDB,1417,L["Young Wetlands Crocolisk"],BZONE["Wetlands"],36.37,44.47)
	...
	self:addLookupList(MobDB,2356,L["Elder Gray Bear"],BZONE["Arathi Highlands"],22.95,24.41)
	...
	self:addLookupList(MobDB,2554,L["Witherbark Axe Thrower"],BZONE["Arathi Highlands"],65.93,67.52)
	...
	self:addLookupList(MobDB,2606,L["Nimar the Slayer"],BZONE["Arathi Highlands"],65.74,68.84)
	...
	self:addLookupList(MobDB,3818,L["Elder Shadowhorn Stag"],BZONE["Ashenvale"],63.60,48.59)
	self:addLookupList(MobDB,3825,L["Ghostpaw Alpha"],BZONE["Ashenvale"],67.87,55.53)
	self:addLookupList(MobDB,3834,L["Crazed Ancient"],BZONE["Ashenvale"],58.39,38.72)
	self:addLookupList(MobDB,3919,L["Withered Ancient"],BZONE["Ashenvale"],58.42,38.89)
	...
	self:addLookupList(MobDB,4341,L["Drywallow Crocolisk"],BZONE["Dustwallow Marsh"],45.98,25.08)
	self:addLookupList(MobDB,4343,L["Drywallow Snapper"],BZONE["Dustwallow Marsh"],39.55,37.75)
	self:addLookupList(MobDB,4364,L["Strashaz Warrior"],BZONE["Dustwallow Marsh"],74.99,19.07)
	...
	self:addLookupList(MobDB,5419,L["Glasshide Basilisk"],BZONE["Un'Goro Crater"],83.81,44.51)
	...
	self:addLookupList(MobDB,5423,L["Scorpid Tail Lasher"],BZONE["Un'Goro Crater"],83.23,39.41)
	self:addLookupList(MobDB,5425,L["Starving Blisterpaw"],BZONE["Un'Goro Crater"],83.13,39.66)
	...
	self:addLookupList(MobDB,5860,L["Twilight Dark Shaman"],BZONE["Searing Gorge"],23.27,36.80)
	self:addLookupList(MobDB,5861,L["Twilight Fire Guard"],BZONE["Searing Gorge"],23.48,34.43)
	self:addLookupList(MobDB,5862,L["Twilight Geomancer"],BZONE["Searing Gorge"],24.50,29.11)
	self:addLookupList(MobDB,5990,L["Redstone Basilisk"],BZONE["Blasted Lands"],58.00,31.28)
	self:addLookupList(MobDB,5993,L["Helboar"],BZONE["Blasted Lands"],55.20,49.78)
	...
	self:addLookupList(MobDB,6514,L["Un'Goro Gorilla"],BZONE["Un'Goro Crater"],64.72,17.00)
	...
	self:addLookupList(MobDB,7037,L["Thaurissan Firewalker"],BZONE["Burning Steppes"],62.89,39.41)
	self:addLookupList(MobDB,7040,L["Black Dragonspawn"],BZONE["Burning Steppes"],87.05,41.88)
	...
	self:addLookupList(MobDB,7372,L["Deadwind Warlock"],BZONE["Deadwind Pass"],61.28,72.61)
	...
	self:addLookupList(MobDB,7444,L["Shardtooth Bear"],BZONE["Winterspring"],42.23,38.84)
	...
	self:addLookupList(MobDB,8546,L["Dark Adept"],BZONE["Eastern Plaguelands"],67.04,36.98)
	self:addLookupList(MobDB,8550,L["Shadowmage"],BZONE["Eastern Plaguelands"],70.91,40.03)
	self:addLookupList(MobDB,8561,L["Mossflayer Shadowhunter"],BZONE["Eastern Plaguelands"],62.77,15.37)
	self:addLookupList(MobDB,8637,L["Dark Iron Watchman"],BZONE["Searing Gorge"],64.24,56.73)
	...
	self:addLookupList(MobDB,9166,L["Pterrordax"],BZONE["Un'Goro Crater"],54.22,47.55)
	...
	self:addLookupList(MobDB,9447,L["Scarlet Warder"],BZONE["Eastern Plaguelands"],75.46,77.57)
	...
	self:addLookupList(MobDB,9695,L["Deathlash Scorpid"],BZONE["Burning Steppes"],63.26,45.56)
	...
	self:addLookupList(MobDB,10119,L["Volchan"],BZONE["Burning Steppes"],82.59,47.76)
	...
	self:addLookupList(MobDB,14454,BBOSS["The Windreaver"],BZONE["Silithus"],26.14,22.01)
	...
	self:addLookupList(MobDB,18062,L["Enraged Crusher"],BZONE["Nagrand"],50.01,41.53)
	...
	self:addLookupList(MobDB,22143,L["Gordunni Back-Breaker"],BZONE["Zangarmarsh"],78.11,94.31)
	self:addLookupList(MobDB,22144,L["Gordunni Elementalist"],BZONE["Zangarmarsh"],73.20,90.83)
	...
	self:addLookupList(MobDB,23061,L["Rivendark"],BZONE["Blade's Edge Mountains"],30.49,59.60)
	...
	self:addLookupList(MobDB,27329,L["Onslaught Bloodhound"],BZONE["Dragonblight"],86.79,37.42)
	...
	self:addLookupList(MobDB,29793,L["Frostfeather Witch"],BZONE["The Storm Peaks"],30.72,68.68)
	...
	self:addLookupList(MobDB,30208,L["Stormforged Ambusher"],BZONE["The Storm Peaks"],70.05,59.86)
