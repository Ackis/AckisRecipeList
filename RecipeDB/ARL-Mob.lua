...
594 found from data mining.  0 ignored.
...
function addon:InitMob(MobDB)
	...
	self:addLookupList(MobDB,764,L["Swampwalker"],BZONE["Swamp of Sorrows"],26.87,38.31)
	self:addLookupList(MobDB,765,L["Swampwalker Elder"],BZONE["Swamp of Sorrows"],11.68,34.63)
	self:addLookupList(MobDB,766,L["Tangled Horror"],BZONE["Swamp of Sorrows"],44.86,42.32)
	...
	self:addLookupList(MobDB,1365,L["Goli Krumn"],BZONE["Ironforge"],29.96,61.74)
	...
	self:addLookupList(MobDB,1815,L["Diseased Black Bear"],BZONE["Tirisfal Glades"],84.50,70.25)
	...
	self:addLookupList(MobDB,1844,L["Foreman Marcrid"],BZONE["Western Plaguelands"],46.45,33.86)
	...
	self:addLookupList(MobDB,2356,L["Elder Gray Bear"],BZONE["Arathi Highlands"],22.94,24.60)
	...
	self:addLookupList(MobDB,2376,L["Torn Fin Oracle"],BZONE["Hillsbrad Foothills"],43.82,67.11)
	...
	self:addLookupList(MobDB,2926,L["Silvermane Stalker"],BZONE["The Hinterlands"],63.76,54.49)
	...
	self:addLookupList(MobDB,3825,L["Ghostpaw Alpha"],BZONE["Ashenvale"],67.88,55.65)
	...
	self:addLookupList(MobDB,4117,L["Cloud Serpent"],BZONE["Thousand Needles"],43.02,48.86)
	self:addLookupList(MobDB,4143,L["Sparkleshell Snapper"],BZONE["Thousand Needles"],81.20,64.61)
	...
	self:addLookupList(MobDB,4341,L["Drywallow Crocolisk"],BZONE["Dustwallow Marsh"],45.96,25.08)
	...
	self:addLookupList(MobDB,4467,L["Vilebranch Soothsayer"],BZONE["The Hinterlands"],52.86,60.66)
	...
	self:addLookupList(MobDB,5420,L["Glasshide Gazer"],BZONE["Tanaris"],51.20,51.26)
	self:addLookupList(MobDB,5422,L["Scorpid Hunter"],BZONE["Tanaris"],54.78,30.07)
	self:addLookupList(MobDB,5423,L["Scorpid Tail Lasher"],BZONE["Un'Goro Crater"],83.32,39.45)
	self:addLookupList(MobDB,5425,L["Starving Blisterpaw"],BZONE["Un'Goro Crater"],83.09,42.93)
	self:addLookupList(MobDB,5426,L["Blisterpaw Hyena"],BZONE["Tanaris"],52.18,46.19)
	...
	self:addLookupList(MobDB,7040,L["Black Dragonspawn"],BZONE["Burning Steppes"],86.90,46.44)
	self:addLookupList(MobDB,7047,L["Black Broodling"],BZONE["Burning Steppes"],87.18,51.67)
	...
	self:addLookupList(MobDB,8546,L["Dark Adept"],BZONE["Eastern Plaguelands"],66.78,36.87)
	...
	self:addLookupList(MobDB,9166,L["Pterrordax"],BZONE["Un'Goro Crater"],54.17,47.75)
	...
	self:addLookupList(MobDB,9447,L["Scarlet Warder"],BZONE["Eastern Plaguelands"],74.97,77.14)
	...
	self:addLookupList(MobDB,13445,L["Great-father Winter"],BZONE["Orgrimmar"],52.74,68.21)
	...
	self:addLookupList(MobDB,14454,BBOSS["The Windreaver"],BZONE["Silithus"],26.22,22.31)
	...
	self:addLookupList(MobDB,18062,L["Enraged Crusher"],BZONE["Nagrand"],50.07,41.28)
	...
	self:addLookupList(MobDB,27329,L["Onslaught Bloodhound"],BZONE["Dragonblight"],86.74,37.50)
	...
	self:addLookupList(MobDB,28123,L["Venture Co. Excavator"],BZONE["Sholazar Basin"],34.83,47.52)
	...
	self:addLookupList(MobDB,28380,L["Shattertusk Bull"],BZONE["Sholazar Basin"],53.00,30.18)
	...
	self:addLookupList(MobDB,29235,L["Gundrak Savage"],BZONE["Zul'Drak"],73.78,30.83)
	...
	self:addLookupList(MobDB,30160,L["Brittle Revenant"],BZONE["The Storm Peaks"],70.22,59.72)
	...
	self:addLookupList(MobDB,30260,L["Stoic Mammoth"],BZONE["The Storm Peaks"],57.28,63.15)
