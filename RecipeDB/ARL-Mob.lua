...
function addon:InitMob(MobDB)
	...
	self:addLookupList(MobDB,547,L["Great Goretusk"],BZONE["Westfall"],58.45,61.67)
	...
	self:addLookupList(MobDB,1017,L["Highland Scytheclaw"],BZONE["Wetlands"],47.34,24.10)
	...
	self:addLookupList(MobDB,2356,L["Elder Gray Bear"],BZONE["Arathi Highlands"],22.97,24.52)
	...
	self:addLookupList(MobDB,2407,L["Hulking Mountain Lion"],BZONE["Hillsbrad Foothills"],39.49,23.02)
	...
	self:addLookupList(MobDB,4147,L["Saltstone Basilisk"],BZONE["Thousand Needles"],75.11,61.02)
	...
	self:addLookupList(MobDB,5853,L["Tempered War Golem"],BZONE["Searing Gorge"],64.32,55.98)
	...
	self:addLookupList(MobDB,7445,L["Elder Shardtooth"],BZONE["Winterspring"],59.52,25.70)
	...
	self:addLookupList(MobDB,8637,L["Dark Iron Watchman"],BZONE["Searing Gorge"],64.41,56.07)
	...
	self:addLookupList(MobDB,9447,L["Scarlet Warder"],BZONE["Eastern Plaguelands"],75.08,77.33)
	...
	self:addLookupList(MobDB,23061,L["Rivendark"],BZONE["Blade's Edge Mountains"],30.54,59.38)
	...
	self:addLookupList(MobDB,23282,L["Obsidia"],BZONE["Blade's Edge Mountains"],31.43,57.72)
	...
	self:addLookupList(MobDB,26206,BBOSS["Keristrasza"],BZONE["Borean Tundra"],29.55,29.95)
