...
function addon:InitMob(MobDB)
	...
	self:addLookupList(MobDB,1017,L["Highland Scytheclaw"],BZONE["Wetlands"],47.24,24.07)
	...
	self:addLookupList(MobDB,1082,L["Sawtooth Crocolisk"],BZONE["Swamp of Sorrows"],54.72,40.91)
	...
	self:addLookupList(MobDB,2356,L["Elder Gray Bear"],BZONE["Arathi Highlands"],22.93,24.62)
	...
	self:addLookupList(MobDB,3809,L["Ashenvale Bear"],BZONE["Ashenvale"],46.77,56.09)
	self:addLookupList(MobDB,3818,L["Elder Shadowhorn Stag"],BZONE["Ashenvale"],63.60,48.41)
	self:addLookupList(MobDB,3825,L["Ghostpaw Alpha"],BZONE["Ashenvale"],67.88,55.66)
	...
	self:addLookupList(MobDB,5474,L["Dunemaul Brute"],BZONE["Tanaris"],41.38,56.63)
	...
	self:addLookupList(MobDB,5714,BBOSS["Loro"],BZONE["Zul'Farrak"],0,0)
