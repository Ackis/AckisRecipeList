...
function addon:InitTrainer(TrainerDB)
	...
	self:addLookupList(TrainerDB,1632,L["Adele Fielder"],BZONE["Elwynn Forest"],46.69,63.07,1)
	...
	self:addLookupList(TrainerDB,1703,L["Uthrar Threx"],BZONE["Ironforge"],44.05,28.84,1)
	...
	self:addLookupList(TrainerDB,2327,L["Shaina Fuller"],BZONE["Stormwind City"],52.45,45.35,1)
	...
	self:addLookupList(TrainerDB,5150,L["Nissa Firestone"],BZONE["Ironforge"],54.79,59.80,1)
	...
	self:addLookupList(TrainerDB,11066,L["Jhag"],BZONE["Orgrimmar"],53.82,38.75,2)
	...
	self:addLookupList(TrainerDB,11178,L["Borgosh Corebender"],BZONE["Orgrimmar"],79.63,25.05,2)
	self:addLookupList(TrainerDB,11557,L["Meilosh"],BZONE["Felwood"],66.25,2.961,0)
	self:addLookupList(TrainerDB,13445,L["Great-father Winter"],BZONE["Orgrimmar"],52.75,68.16,0)
	...
	self:addLookupList(TrainerDB,16724,L["Miall"],BZONE["The Exodar"],60.77,89.27,1)
	...
	self:addLookupList(TrainerDB,28703,L["Linzy Blackbolt"],BZONE["Dalaran"],41.74,31.89,0)
	...
	self:addLookupList(TrainerDB,30711,L["Margaux Parchley"],BZONE["Undercity"],61.13,58.33,2)
