...
function addon:InitTrainer(TrainerDB)
	...
	self:addLookupList(TrainerDB,2327,L["Shaina Fuller"],BZONE["Stormwind City"],52.45,45.37,1)
	...
	self:addLookupList(TrainerDB,13445,L["Great-father Winter"],BZONE["Orgrimmar"],52.73,68.16,0)
