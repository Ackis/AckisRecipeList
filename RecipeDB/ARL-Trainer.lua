...
function addon:InitTrainer(TrainerDB)
	...
	self:addLookupList(TrainerDB,1383,L["Snarl"],BZONE["Orgrimmar"],79.79,24.38,2)
	...
	self:addLookupList(TrainerDB,3478,L["Traugh"],BZONE["The Barrens"],51.84,29.08,2)
	...
	self:addLookupList(TrainerDB,5997,L["Nethergarde Engineer"],BZONE["Blasted Lands"],61.60,7.443,1)
	...
	self:addLookupList(TrainerDB,11028,L["Jemma Quikswitch"],BZONE["Ironforge"],68.79,44.46,1)
	...
	self:addLookupList(TrainerDB,13445,L["Great-father Winter"],BZONE["Orgrimmar"],52.74,68.21,0)
	...
	self:addLookupList(TrainerDB,22835,L["Cenarion Dreamwarden"],BZONE["Moonglade"],71.76,62.09,0)
	...
	self:addLookupList(TrainerDB,30716,L["Thoth"],BZONE["The Exodar"],39.77,38.90,1)
