...
function addon:InitTrainer(TrainerDB)
	...
	self:addLookupList(TrainerDB, 11557, L["Meilosh"], BZONE["Felwood"], 63.97, 2.974, 4)
	...
	self:addLookupList(TrainerDB, 19248, L["Enchanter Salias"], BZONE["Shattrath City"], 43.60, 90.07, 4)
