...
function addon:InitTrainer(TrainerDB)
	...
	self:addLookupList(TrainerDB,4552,L["Eunice Burch"],BZONE["Undercity"],63.44,43.802)
	...
	self:addLookupList(TrainerDB,7230,L["Shayis Steelfury"],BZONE["Orgrimmar"],80.33,23.662)
	...
	self:addLookupList(TrainerDB,11017,L["Roxxik"],BZONE["Orgrimmar"],75.85,22.692)
	...
	self:addLookupList(TrainerDB,16719,L["Mumman"],BZONE["The Exodar"],56.71,28.591)
	...
	self:addLookupList(TrainerDB,16746,L["Kayaart"],BZONE["The Exodar"],63.15,68.621)
	...
	self:addLookupList(TrainerDB,17442,L["Moordo"],BZONE["Azuremyst Isle"],45.14,23.721)
