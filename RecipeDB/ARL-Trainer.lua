...
function addon:InitTrainer(TrainerDB)
	...
	self:addLookupList(TrainerDB,1386,L["Rogvar"],BZONE["Orgrimmar"],39.58,59.79,2)
	...
	self:addLookupList(TrainerDB,2327,L["Shaina Fuller"],BZONE["Stormwind City"],52.46,45.34,1)
	...
	self:addLookupList(TrainerDB,4552,L["Eunice Burch"],BZONE["Undercity"],63.44,43.82,2)
	...
	self:addLookupList(TrainerDB,5174,L["Springspindle Fizzlegear"],BZONE["Ironforge"],68.81,45.42,1)
	self:addLookupList(TrainerDB,5177,L["Tally Berryfizz"],BZONE["Ironforge"],67.10,54.87,1)
	...
	self:addLookupList(TrainerDB,5997,L["Nethergarde Engineer"],BZONE["Blasted Lands"],61.51,7.463,1)
	...
	self:addLookupList(TrainerDB,7944,L["Tinkmaster Overspark"],BZONE["Ironforge"],70.58,50.34,1)
	...
	self:addLookupList(TrainerDB,10266,L["Ug'thok"],BZONE["Orgrimmar"],80.26,23.77,2)
	self:addLookupList(TrainerDB,10276,L["Rotgath Stonebeard"],BZONE["Ironforge"],51.85,43.05,1)
	...
	self:addLookupList(TrainerDB,11031,L["Franklin Lloyd"],BZONE["Undercity"],76.81,73.93,2)
	...
	self:addLookupList(TrainerDB,11047,L["Kray"],BZONE["Thunder Bluff"],47.74,34.76,2)
	self:addLookupList(TrainerDB,11048,L["Victor Ward"],BZONE["Undercity"],71.39,29.90,2)
	...
	self:addLookupList(TrainerDB,11178,L["Borgosh Corebender"],BZONE["Orgrimmar"],79.61,24.57,2)
	self:addLookupList(TrainerDB,11557,L["Meilosh"],BZONE["Felwood"],66.25,2.961,0)
	self:addLookupList(TrainerDB,13445,L["Great-father Winter"],BZONE["Orgrimmar"],52.76,68.16,0)
	...
	self:addLookupList(TrainerDB,16161,L["Arcanist Sheynathren"],BZONE["Eversong Woods"],38.12,71.91,2)
	...
	self:addLookupList(TrainerDB,16669,L["Bemarrin"],BZONE["Silvermoon City"],79.72,40.51,2)
	self:addLookupList(TrainerDB,16671,L["Mirvedon"],BZONE["Silvermoon City"],80.04,36.72,2)
	...
	self:addLookupList(TrainerDB,16723,L["Lucc"],BZONE["The Exodar"],28.63,61.87,1)
	...
	self:addLookupList(TrainerDB,17634,L["K. Lee Smallfry"],BZONE["Zangarmarsh"],68.29,51.35,1)
	...
	self:addLookupList(TrainerDB,18774,L["Tatiana"],BZONE["Ironforge"],44.06,42.05,1)
	...
	self:addLookupList(TrainerDB,19187,L["Darmari"],BZONE["Shattrath City"],67.35,66.93,0)
	...
	self:addLookupList(TrainerDB,22861,L["Lightsworn Vindicator"],BZONE["Ironforge"],59.23,67.15,1)
	self:addLookupList(TrainerDB,24315,L["Ancient Female Vrykul"],BZONE["Howling Fjord"],60.42,49.80,0)
	self:addLookupList(TrainerDB,24868,L["NiobeWhizzlespark"],BZONE["Shadowmoon Valley"],37.38,54.95,1)
	...
	self:addLookupList(TrainerDB,26564,L["Borus Ironbender"],BZONE["Dragonblight"],37.10,46.77,2)
	...
	self:addLookupList(TrainerDB,30716,L["Thoth"],BZONE["The Exodar"],39.68,39.21,1)
