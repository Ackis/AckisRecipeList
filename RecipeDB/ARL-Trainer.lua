...
function addon:InitTrainer(TrainerDB)
	...
	self:addLookupList(TrainerDB,3357,L["Makaru"],BZONE["Orgrimmar"],72.96,27.69,2)
	...
	self:addLookupList(TrainerDB,4596,L["James Van Brunt"],BZONE["Undercity"],61.46,30.46,2)
	self:addLookupList(TrainerDB,4598,L["Brom Killian"],BZONE["Undercity"],56.13,36.06,2)
	self:addLookupList(TrainerDB,4605,L["Basil Frye"],BZONE["Undercity"],59.91,28.81,2)
	self:addLookupList(TrainerDB,4609,L["Doctor Marsh"],BZONE["Undercity"],52.99,73.96,2)
	...
	self:addLookupList(TrainerDB,5150,L["Nissa Firestone"],BZONE["Ironforge"],54.81,59.83,1)
	...
	self:addLookupList(TrainerDB,11026,L["Sprite Jumpsprocket"],BZONE["Stormwind City"],62.36,31.33,1)
	...
	self:addLookupList(TrainerDB,11096,L["Randal Worth"],BZONE["Stormwind City"],71.98,61.91,1)
	...
	self:addLookupList(TrainerDB,16634,L["Dolothos"],BZONE["Silvermoon City"],68.60,25.60,2)
	...
	self:addLookupList(TrainerDB,16745,L["Feruul"],BZONE["The Exodar"],66.37,74.57,1)
	self:addLookupList(TrainerDB,16746,L["Kayaart"],BZONE["The Exodar"],63.27,69.15,1)
	...
	self:addLookupList(TrainerDB,19775,L["Kalinda"],BZONE["Silvermoon City"],90.53,67.99,2)
