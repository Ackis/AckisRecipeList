...
334 found from data mining.  0 ignored.
...
function addon:InitTrainer(TrainerDB)
	...
	self:addLookupList(TrainerDB,1103,L["Eldrin"],BZONE["Elwynn Forest"],79.62,65.991)
	...
	self:addLookupList(TrainerDB,2327,L["Shaina Fuller"],BZONE["Stormwind City"],52.49,45.271)
	...
	self:addLookupList(TrainerDB,3011,L["Teg Dawnstrider"],BZONE["Thunder Bluff"],45.58,40.822)
	...
	self:addLookupList(TrainerDB,3136,L["Clarise Gnarltree"],BZONE["Duskwood"],73.65,49.641)
	...
	self:addLookupList(TrainerDB,3355,L["Saru Steelfury"],BZONE["Orgrimmar"],81.68,23.432)
	...
	self:addLookupList(TrainerDB,4254,L["Geofram Bouldertoe"],BZONE["Ironforge"],51.04,26.901)
	...
	self:addLookupList(TrainerDB,4578,L["Josephine Lister"],BZONE["Undercity"],85.51,23.992)
	...
	self:addLookupList(TrainerDB,4605,L["Basil Frye"],BZONE["Undercity"],60.04,29.032)
	...
	self:addLookupList(TrainerDB,5150,L["Nissa Firestone"],BZONE["Ironforge"],54.80,59.811)
	...
	self:addLookupList(TrainerDB,5164,L["Grumnus Steelshaper"],BZONE["Ironforge"],50.87,43.121)
	...
	self:addLookupList(TrainerDB,5518,L["Lilliam Sparkspindle"],BZONE["Stormwind City"],62.26,31.041)
	...
	self:addLookupList(TrainerDB,5997,L["Nethergarde Engineer"],BZONE["Blasted Lands"],61.51,7.4651)
	...
	self:addLookupList(TrainerDB,7871,L["Se'Jib"],BZONE["Stranglethorn Vale"],37.21,34.742)
	...
	self:addLookupList(TrainerDB,10266,L["Ug'thok"],BZONE["Orgrimmar"],80.26,23.872)
	...
	self:addLookupList(TrainerDB,11029,L["Trixie Quikswitch"],BZONE["Ironforge"],68.84,45.301)
	self:addLookupList(TrainerDB,11031,L["Franklin Lloyd"],BZONE["Undercity"],76.82,73.952)
	self:addLookupList(TrainerDB,11037,L["Jenna Lemkenilli"],BZONE["Darkshore"],37.87,41.111)
	self:addLookupList(TrainerDB,11041,L["Milla Fairancora"],BZONE["Darnassus"],54.63,22.071)
	...
	self:addLookupList(TrainerDB,16671,L["Mirvedon"],BZONE["Silvermoon City"],80.04,36.682)
	...
	self:addLookupList(TrainerDB,16703,L["Amin"],BZONE["Silvermoon City"],90.38,74.842)
	self:addLookupList(TrainerDB,16719,L["Mumman"],BZONE["The Exodar"],56.71,28.611)
	self:addLookupList(TrainerDB,16723,L["Lucc"],BZONE["The Exodar"],28.61,61.921)
	...
	self:addLookupList(TrainerDB,16726,L["Ockil"],BZONE["The Exodar"],55.12,91.851)
	...
	self:addLookupList(TrainerDB,16741,L["Deriz"],BZONE["The Exodar"],28.85,61.611)
	...
	self:addLookupList(TrainerDB,17487,L["Erin Kelly"],BZONE["Azuremyst Isle"],46.85,70.151)
	...
	self:addLookupList(TrainerDB,19184,L["Mildred Fletcher"],BZONE["Shattrath City"],65.98,14.600)
	...
	self:addLookupList(TrainerDB,22823,L["Hch'uu"],BZONE["Zangarmarsh"],19.78,52.040)
	...
	self:addLookupList(TrainerDB,22835,L["Cenarion Dreamwarden"],BZONE["Moonglade"],71.62,62.000)
	...
	self:addLookupList(TrainerDB,26955,L["Jamesina Watterly"],BZONE["Howling Fjord"],78.15,27.872)
	...
	self:addLookupList(TrainerDB,30706,L["Jo'mah"],BZONE["Orgrimmar"],55.93,45.772)
	self:addLookupList(TrainerDB,30709,L["Poshken Hardbinder"],BZONE["Thunder Bluff"],28.65,20.922)
	self:addLookupList(TrainerDB,30710,L["Zantasia"],BZONE["Silvermoon City"],69.15,24.912)
	self:addLookupList(TrainerDB,30711,L["Margaux Parchley"],BZONE["Undercity"],61.14,58.302)
	...
	self:addLookupList(TrainerDB,30716,L["Thoth"],BZONE["The Exodar"],39.68,39.211)
