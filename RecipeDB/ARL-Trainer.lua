...
function addon:InitTrainer(TrainerDB)
	...
	self:addLookupList(TrainerDB,7868,L["Sarah Tanner"],BZONE["Searing Gorge"],63.38,75.241)
	...
	self:addLookupList(TrainerDB,11026,L["Sprite Jumpsprocket"],BZONE["Stormwind City"],62.39,31.371)
	...
	self:addLookupList(TrainerDB,16669,L["Bemarrin"],BZONE["Silvermoon City"],80.07,41.022)
