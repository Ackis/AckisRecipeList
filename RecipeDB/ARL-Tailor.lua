...
function addon:InitTailoring(RecipeDB)
	...
	self:addTradeAcquire(RecipeDB,7639,2,843,2,1347,2,5944)
	...
	self:addTradeFlags(RecipeDB,18454,1,2,6,11,26,36,40,56)
	...
	self:addTradeFlags(RecipeDB,20849,1,2,4,26,36,41,56)
