...
function addon:InitEngineering(RecipeDB)
	...
	self:addTradeAcquire(RecipeDB,44155,1,24868,1,25099,1,25277,1,28697,1,26955,1,33586)
	...
	self:addTradeAcquire(RecipeDB,67920,1,25277,1,28697,1,26955,1,33586)
