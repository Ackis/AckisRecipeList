...
function addon:InitFirstAid(RecipeDB)
	...
	-- Linen Bandage -- 3275
	self:addTradeSkill(RecipeDB,3275,1,1251,1,45542,nil,GAME_ORIG,1,30,45,60)
	self:addTradeFlags(RecipeDB,3275,1,2,3,36,41)
	self:addTradeAcquire(RecipeDB,3275,8,8)

	-- Heavy Linen Bandage -- 3276
	self:addTradeSkill(RecipeDB,3276,40,2581,1,45542,nil,GAME_ORIG,40,50,75,100)
	self:addTradeFlags(RecipeDB,3276,1,2,3,36,41)
	...
	-- Wool Bandage -- 3277
	self:addTradeSkill(RecipeDB,3277,80,3530,1,45542,nil,GAME_ORIG,0,80,115,150)
	self:addTradeFlags(RecipeDB,3277,1,2,3,36,41)
	...
	self:addTradeSkill(RecipeDB,3278,115,3531,1,45542,nil,GAME_ORIG,0,115,150,185)
	self:addTradeFlags(RecipeDB,3278,1,2,3,36,41)
	...
	-- Silk Bandage -- 7928
	self:addTradeSkill(RecipeDB,7928,150,6450,1,45542,nil,GAME_ORIG,0,150,180,210)
	self:addTradeFlags(RecipeDB,7928,1,2,3,36,41)
	...
	self:addTradeSkill(RecipeDB,7929,180,6451,1,45542,nil,GAME_ORIG,0,180,210,240)
	self:addTradeFlags(RecipeDB,7929,1,2,3,36,40)
	...
	-- Anti-Venom -- 7934
	self:addTradeSkill(RecipeDB,7934,80,6452,1,45542,nil,GAME_ORIG,0,80,115,150)
	self:addTradeFlags(RecipeDB,7934,1,2,3,36,41)
	...
	self:addTradeSkill(RecipeDB,7935,130,6453,2,45542,nil,GAME_ORIG,0,130,165,200)
	self:addTradeFlags(RecipeDB,7935,1,2,10,36,40)
	self:addTradeAcquire(RecipeDB,7935,7,2)

	-- Mageweave Bandage -- 10840
	self:addTradeSkill(RecipeDB,10840,210,8544,1,45542,nil,GAME_ORIG,0,210,240,270)
	self:addTradeFlags(RecipeDB,10840,1,2,3,36,40)
	...
	self:addTradeSkill(RecipeDB,10841,240,8545,1,45542,nil,GAME_ORIG,0,240,270,300)
	self:addTradeFlags(RecipeDB,10841,1,2,3,36,41)
	...
	self:addTradeSkill(RecipeDB,18629,260,14529,1,45542,nil,GAME_ORIG,0,260,290,320)
	self:addTradeFlags(RecipeDB,18629,1,2,3,36,41)
	...
	self:addTradeSkill(RecipeDB,18630,290,14530,1,45542,nil,GAME_ORIG,0,290,320,350)
	self:addTradeFlags(RecipeDB,18630,1,2,3,36,41)
	...
	self:addTradeSkill(RecipeDB,23787,300,19440,1,45542,nil,GAME_ORIG,0,300,330,360)
	self:addTradeFlags(RecipeDB,23787,1,2,4,36,41,96)
	self:addTradeAcquire(RecipeDB,23787,6,529,2,10856,6,529,2,10857,6,529,2,11536)

	-- Netherweave Bandage -- 27032
	self:addTradeSkill(RecipeDB,27032,300,21990,1,45542,nil,1,GAME_ORIG,330,347,365)
	self:addTradeFlags(RecipeDB,27032,1,2,3,36,40)
	self:addTradeAcquire(RecipeDB,27032,1,33589,1,28706,1,18991,1,29233,1,18990,1,26956,
	1,26992,1,23734)

	-- Heavy Netherweave Bandage -- 27033
	self:addTradeSkill(RecipeDB,27033,330,21991,1,45542,nil,1,GAME_ORIG,360,367,375)
	self:addTradeFlags(RecipeDB,27033,1,2,3,36,40)
	...
	self:addTradeFlags(RecipeDB,45545,1,2,3,36,41)
	self:addTradeAcquire(RecipeDB,45545,1,23734,1,26956,1,26992,1,28706,1,29233,1,33589)

	-- Heavy Frostweave Bandage -- 45546
	self:addTradeSkill(RecipeDB,45546,400,34722,2,45542,nil,2,GAME_ORIG,400,430,470)
	self:addTradeFlags(RecipeDB,45546,1,2,10,36,41)
