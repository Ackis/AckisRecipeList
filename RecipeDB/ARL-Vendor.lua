...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,3356,L["Sumi"],BZONE["Orgrimmar"],82.83,23.022)
	...
	self:addLookupList(VendorDB,3367,L["Felika"],BZONE["Orgrimmar"],58.21,50.972)
	...
	self:addLookupList(VendorDB,4186,L["Mavralyn"],BZONE["Darkshore"],37.30,40.851)
	...
	self:addLookupList(VendorDB,4561,L["Daniel Bartlett"],BZONE["Undercity"],65.16,39.312)
	...
	self:addLookupList(VendorDB,5757,L["Lilly"],BZONE["Silverpine Forest"],43.80,50.252)
	...
	self:addLookupList(VendorDB,18951,L["Erilia"],BZONE["Eversong Woods"],56.05,54.462)
	...
	self:addLookupList(VendorDB,18991,L["Aresella"],BZONE["Hellfire Peninsula"],26.28,62.302)
	self:addLookupList(VendorDB,19004,L["Vodesiin"],BZONE["Hellfire Peninsula"],24.04,39.191)
	self:addLookupList(VendorDB,19015,L["Mathar G'ochar"],BZONE["Nagrand"],56.21,38.152)
	...
	self:addLookupList(VendorDB,32774,L["Sebastian Crane"],BZONE["Howling Fjord"],79.54,32.822)
