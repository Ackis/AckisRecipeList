...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,1304,L["Darian Singh"],BZONE["Stormwind City"],42.94,76.10,1)
	...
	self:addLookupList(VendorDB,5162,L["Tansy Puddlefizz"],BZONE["Ironforge"],48.22,6.002,1)
	...
	self:addLookupList(VendorDB,5512,L["Kaita Deepforge"],BZONE["Stormwind City"],62.99,38.03,1)
	...
	self:addLookupList(VendorDB,6576,L["Brienna Starglow"],BZONE["Thousand Needles"],9.069,19.08,1)
	...
	self:addLookupList(VendorDB,13432,L["Seersa Copperpinch"],BZONE["Thunder Bluff"],42.19,55.55,2)
	self:addLookupList(VendorDB,13433,L["Wulmort Jinglepocket"],BZONE["Ironforge"],33.10,66.94,0)
	self:addLookupList(VendorDB,13435,L["Khole Jinglepocket"],BZONE["Stormwind City"],61.90,71.28,1)
	...
	self:addLookupList(VendorDB,23010,L["Wolgren Jinglepocket"],BZONE["The Exodar"],54.65,47.71,1)
