...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,3367,L["Felika"],BZONE["Orgrimmar"],58.27,50.88,0)
	...
	self:addLookupList(VendorDB,16365,L["Master Craftsman Omarion"],BZONE["Naxxaramas"],0,0,0)
