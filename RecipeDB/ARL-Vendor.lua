...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,28714,L["Ildine Sorrowspear"],BZONE["Dalaran"],39.16,41.22,0)
	self:addLookupList(VendorDB,28721,L["Tiffany Cartier"],BZONE["Dalaran"],40.08,34.30,0)
	...
	self:addLookupList(VendorDB,32514,L["Vanessa Sellers"],BZONE["Dalaran"],38.63,40.77,0)
