...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,1304,L["Darian Singh"],BZONE["Stormwind City"],42.95,76.091)
	...
	self:addLookupList(VendorDB,2383,L["Lindea Rabonne"],BZONE["Hillsbrad Foothills"],50.95,61.211)
	...
	self:addLookupList(VendorDB,2843,L["Jutak"],BZONE["Stranglethorn Vale"],27.61,77.960)
	...
	self:addLookupList(VendorDB,3029,L["Sewa Mistrunner"],BZONE["Thunder Bluff"],55.31,48.592)
	...
	self:addLookupList(VendorDB,3413,L["Sovik"],BZONE["Orgrimmar"],75.72,26.272)
	...
	self:addLookupList(VendorDB,4561,L["Daniel Bartlett"],BZONE["Undercity"],65.10,39.292)
	self:addLookupList(VendorDB,4574,L["Lizbeth Cromwell"],BZONE["Undercity"],81.47,31.562)
	self:addLookupList(VendorDB,4577,L["Millie Gregorian"],BZONE["Undercity"],71.19,28.682)
	...
	self:addLookupList(VendorDB,5162,L["Tansy Puddlefizz"],BZONE["Ironforge"],47.89,6.7441)
	...
	self:addLookupList(VendorDB,5411,L["Krinkle Goodsteel"],BZONE["Tanaris"],51.90,29.210)
	...
	self:addLookupList(VendorDB,5512,L["Kaita Deepforge"],BZONE["Stormwind City"],63.32,37.221)
	...
	self:addLookupList(VendorDB,8177,L["Rartar"],BZONE["Swamp of Sorrows"],44.93,57.520)
	...
	self:addLookupList(VendorDB,12958,L["Gigget Zipcoil"],BZONE["The Hinterlands"],34.36,37.990)
	...
	self:addLookupList(VendorDB,16713,L["Arras"],BZONE["The Exodar"],60.45,88.441)
	self:addLookupList(VendorDB,16718,L["Phea"],BZONE["The Exodar"],56.22,27.991)
	self:addLookupList(VendorDB,16722,L["Egomis"],BZONE["The Exodar"],39.44,39.561)
	...
	self:addLookupList(VendorDB,19195,L["Jim Saltit"],BZONE["Shattrath City"],63.75,69.770)
	...
	self:addLookupList(VendorDB,20028,L["Doba"],BZONE["Blade's Edge Mountains"],28.59,92.430)
	...
	self:addLookupList(VendorDB,29510,L["Linna Bruder"],BZONE["Dalaran"],34.70,33.560)
