...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,340,L["Kendor Kabonka"],BZONE["Stormwind City"],76.85,52.11,1)
	...
	self:addLookupList(VendorDB,1304,L["Darian Singh"],BZONE["Stormwind City"],42.90,76.00,1)
	...
	self:addLookupList(VendorDB,3134,L["Kzixx"],BZONE["Duskwood"],81.81,18.81,0)
	...
	self:addLookupList(VendorDB,3364,L["Borya"],BZONE["Orgrimmar"],63.08,50.48,2)
	...
	self:addLookupList(VendorDB,4228,L["Vaean"],BZONE["Darnassus"],59.09,14.94,1)
	self:addLookupList(VendorDB,4229,L["Mythrin'dir"],BZONE["Darnassus"],60.70,19.77,1)
	...
	self:addLookupList(VendorDB,4574,L["Lizbeth Cromwell"],BZONE["Undercity"],81.56,31.24,2)
	...
	self:addLookupList(VendorDB,5162,L["Tansy Puddlefizz"],BZONE["Ironforge"],47.90,6.703,1)
	self:addLookupList(VendorDB,5163,L["Burbik Gearspanner"],BZONE["Ironforge"],46.17,27.98,1)
	...
	self:addLookupList(VendorDB,5483,L["Erika Tate"],BZONE["Stormwind City"],77.92,53.03,1)
	...
	self:addLookupList(VendorDB,8681,L["Outfitter Eric"],BZONE["Ironforge"],43.72,29.08,1)
	...
	self:addLookupList(VendorDB,11536,L["Quartermaster Miranda Breechlock"],BZONE["Eastern Plaguelands"],75.99,52.18,0)
	...
	self:addLookupList(VendorDB,12959,L["Nergal"],BZONE["Un'Goro Crater"],43.97,7.901,0)
	...
	self:addLookupList(VendorDB,20028,L["Doba"],BZONE["Blade's Edge Mountains"],28.57,92.37,0)
	...
	self:addLookupList(VendorDB,28714,L["Ildine Sorrowspear"],BZONE["Dalaran"],39.17,41.22,0)
	self:addLookupList(VendorDB,28721,L["Tiffany Cartier"],BZONE["Dalaran"],40.09,34.30,0)
	self:addLookupList(VendorDB,29510,L["Linna Bruder"],BZONE["Dalaran"],34.67,33.53,0)
	self:addLookupList(VendorDB,29511,L["Lalla Brightweave"],BZONE["Dalaran"],36.68,33.33,0)
	self:addLookupList(VendorDB,29512,L["Ainderu Summerleaf"],BZONE["Dalaran"],37.05,33.73,0)
	self:addLookupList(VendorDB,30431,L["Veteran Crusader Aliocha Segard"],BZONE["Icecrown"],87.57,74.83,0)
	self:addLookupList(VendorDB,30489,L["Morgan Day"],BZONE["Wintergrasp"],49.29,17.92,1)
	self:addLookupList(VendorDB,31031,L["Misensi"],BZONE["Dalaran"],69.77,37.71,0)
	self:addLookupList(VendorDB,31032,L["Derek Odds"],BZONE["Dalaran"],41.06,65.66,0)
	...
	self:addLookupList(VendorDB,32287,L["Archmage Alvareaux"],BZONE["Dalaran"],26.51,47.86,0)
	self:addLookupList(VendorDB,32294,L["Knight Dameron"],BZONE["Wintergrasp"],51.47,17.49,0)
	self:addLookupList(VendorDB,32296,L["Stone Guard Mukar"],BZONE["Wintergrasp"],51.10,17.86,0)
	self:addLookupList(VendorDB,32514,L["Vanessa Sellers"],BZONE["Dalaran"],38.64,40.78,0)
	self:addLookupList(VendorDB,32515,L["Braeg Stoutbeard"],BZONE["Dalaran"],38.52,29.61,0)
	...
	self:addLookupList(VendorDB,32540,L["Lillehoff"],BZONE["The Storm Peaks"],65.85,61.51,0)
