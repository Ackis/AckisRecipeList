...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,1250,L["Drake Lindgren"],BZONE["Elwynn Forest"],82.84,63.43,1)
	...
	self:addLookupList(VendorDB,2383,L["Lindea Rabonne"],BZONE["Hillsbrad Foothills"],50.94,61.16,1)
	...
	self:addLookupList(VendorDB,2668,L["Danielle Zipstitch"],BZONE["Duskwood"],76.45,46.69,1)
	...
	self:addLookupList(VendorDB,2684,L["Rizz Loosebolt"],BZONE["Alterac Mountains"],47.59,35.42,0)
	...
	self:addLookupList(VendorDB,3178,L["Stuart Fleming"],BZONE["Wetlands"],8.600,59.03,1)
	...
	self:addLookupList(VendorDB,3537,L["Zixil"],BZONE["Hillsbrad Foothills"],56.43,30.59,0)
	...
	self:addLookupList(VendorDB,4226,L["Ulthir"],BZONE["Darnassus"],55.74,24.00,1)
	...
	self:addLookupList(VendorDB,4574,L["Lizbeth Cromwell"],BZONE["Undercity"],81.41,31.13,2)
	...
	self:addLookupList(VendorDB,4877,L["Jandia"],BZONE["Undercity"],46.42,65.18,2)
	...
	self:addLookupList(VendorDB,5162,L["Tansy Puddlefizz"],BZONE["Ironforge"],47.89,6.824,1)
	...
	self:addLookupList(VendorDB,6574,L["Jun'ha"],BZONE["Arathi Highlands"],73.00,37.96,2)
	self:addLookupList(VendorDB,6576,L["Brienna Starglow"],BZONE["Thousand Needles"],9.072,19.08,1)
	...
	self:addLookupList(VendorDB,7733,L["Innkeeper Fizzgrimble"],BZONE["Ironforge"],56.43,80.80,0)
	...
	self:addLookupList(VendorDB,7947,L["Vivianna"],BZONE["Feralas"],31.20,43.27,1)
	...
	self:addLookupList(VendorDB,11278,L["Magnus Frostwake"],BZONE["Western Plaguelands"],67.96,77.42,0)
	...
	self:addLookupList(VendorDB,12958,L["Gigget Zipcoil"],BZONE["The Hinterlands"],34.36,38.00,0)
	...
	self:addLookupList(VendorDB,13429,L["Nardstrum Copperpinch"],BZONE["Undercity"],67.77,40.11,2)
	self:addLookupList(VendorDB,13432,L["Seersa Copperpinch"],BZONE["Thunder Bluff"],42.17,55.59,2)
	self:addLookupList(VendorDB,13433,L["Wulmort Jinglepocket"],BZONE["Ironforge"],33.08,66.93,0)
	...
	self:addLookupList(VendorDB,16224,L["Rathis Tomber"],BZONE["Ghostlands"],47.00,28.58,2)
	...
	self:addLookupList(VendorDB,16657,L["Feera"],BZONE["The Exodar"],55.48,90.52,1)
	self:addLookupList(VendorDB,16670,L["Eriden"],BZONE["Silvermoon City"],80.28,39.77,2)
	...
	self:addLookupList(VendorDB,16705,L["Altaa"],BZONE["The Exodar"],28.15,62.15,1)
	...
	self:addLookupList(VendorDB,16826,L["Sid Limbardi"],BZONE["Ironforge"],58.55,55.91,1)
	self:addLookupList(VendorDB,17246,L["\"Cookie\" McWeaksauce"],BZONE["Bloodmyst Isle"],54.11,55.28,1)
	...
	self:addLookupList(VendorDB,18484,L["Wind Trader Lathrai"],BZONE["Shattrath City"],72.68,31.83,0)
	...
	self:addLookupList(VendorDB,19296,L["Innkeeper Biribi"],BZONE["Ironforge"],50.93,74.39,1)
	self:addLookupList(VendorDB,19321,L["Quartermaster Endarin"],BZONE["Shattrath City"],48.19,26.81,1)
	self:addLookupList(VendorDB,19331,L["Quartermaster Enuril"],BZONE["Shattrath City"],60.00,63.85,0)
	...
	self:addLookupList(VendorDB,20028,L["Doba"],BZONE["Blade's Edge Mountains"],28.63,92.56,1)
	...
	self:addLookupList(VendorDB,21655,L["Nakodu"],BZONE["Shattrath City"],62.91,68.98,0)
	...
	self:addLookupList(VendorDB,23010,L["Wolgren Jinglepocket"],BZONE["The Exodar"],54.73,47.80,1)
	self:addLookupList(VendorDB,23012,L["Hotoppik Copperpinch"],BZONE["Silvermoon City"],63.50,77.20,2)
	self:addLookupList(VendorDB,23064,L["Eebee Jinglepocket"],BZONE["Shattrath City"],51.41,31.17,0)
	...
	self:addLookupList(VendorDB,27030,L["Bradley Towns"],BZONE["Dragonblight"],76.59,59.94,2)
	self:addLookupList(VendorDB,27054,L["Modoru"],BZONE["Ironforge"],38.34,56.76,1)
	...
	self:addLookupList(VendorDB,32287,L["Archmage Alvareaux"],BZONE["Dalaran"],26.39,47.82,0)
	self:addLookupList(VendorDB,32294,L["Knight Dameron"],BZONE["Wintergrasp"],51.40,17.53,1)
	self:addLookupList(VendorDB,32296,L["Stone Guard Mukar"],BZONE["Wintergrasp"],51.16,17.75,2)
	self:addLookupList(VendorDB,32379,L["Captain O'Neal"],BZONE["Stormwind City"],75.34,66.38,1)
	self:addLookupList(VendorDB,32382,L["Lady Palanseer"],BZONE["Orgrimmar"],37.09,64.83,2)
