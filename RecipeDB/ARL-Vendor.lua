...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,5162,L["Tansy Puddlefizz"],BZONE["Ironforge"],48.22,5.989,1)
	...
	self:addLookupList(VendorDB,8508,L["Gretta Ganter"],BZONE["Dun Morogh"],31.54,44.97,1)
	...
	self:addLookupList(VendorDB,8681,L["Outfitter Eric"],BZONE["Ironforge"],43.61,29.74,1)
	...
	self:addLookupList(VendorDB,13432,L["Seersa Copperpinch"],BZONE["Thunder Bluff"],42.18,55.50,2)
	...
	self:addLookupList(VendorDB,23064,L["Eebee Jinglepocket"],BZONE["Shattrath City"],51.15,30.96,0)
	...
	self:addLookupList(VendorDB,28714,L["Ildine Sorrowspear"],BZONE["Dalaran"],39.21,41.00,0)
	...
	self:addLookupList(VendorDB,30489,L["Morgan Day"],BZONE["Wintergrasp"],49.33,17.89,1)
	...
	self:addLookupList(VendorDB,32382,L["Lady Palanseer"],BZONE["Orgrimmar"],37.07,64.79,2)
