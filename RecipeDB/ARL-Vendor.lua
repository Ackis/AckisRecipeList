...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,2483,L["Narkk"],BZONE["Stranglethorn Vale"],28.20,74.50,0)
	...
	self:addLookupList(VendorDB,3955,L["Shandrina"],BZONE["Ashenvale"],49.50,67.10,2)
	...
	self:addLookupList(VendorDB,7733,L["Innkeeper Fizzgrimble"],BZONE["Ironforge"],56.43,80.81,0)
	...
	self:addLookupList(VendorDB,18255,L["Apprentice Darius"],BZONE["Orgrimmar"],48.75,80.91,0)
	...
	self:addLookupList(VendorDB,18987,L["Gaston"],BZONE["Hellfire Peninsula"],54.10,63.50,2)
	...
	self:addLookupList(VendorDB,19296,L["Innkeeper Biribi"],BZONE["Ironforge"],50.94,74.40,1)
	...
	self:addLookupList(VendorDB,20028,L["Doba"],BZONE["Blade's Edge Mountains"],28.64,92.58,1)
