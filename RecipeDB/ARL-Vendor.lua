...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,1304,L["Darian Singh"],BZONE["Stormwind City"],42.95,76.11,1)
	...
	self:addLookupList(VendorDB,3134,L["Kzixx"],BZONE["Duskwood"],81.67,18.79,0)
	...
	self:addLookupList(VendorDB,4877,L["Jandia"],BZONE["Undercity"],45.48,63.85,2)
	...
	self:addLookupList(VendorDB,5162,L["Tansy Puddlefizz"],BZONE["Ironforge"],48.22,6.007,1)
	self:addLookupList(VendorDB,5163,L["Burbik Gearspanner"],BZONE["Ironforge"],47.07,27.92,1)
	...
	self:addLookupList(VendorDB,6576,L["Brienna Starglow"],BZONE["Thousand Needles"],9.070,19.08,1)
	...
	self:addLookupList(VendorDB,7733,L["Innkeeper Fizzgrimble"],BZONE["Ironforge"],56.41,80.78,0)
	...
	self:addLookupList(VendorDB,11278,L["Magnus Frostwake"],BZONE["Western Plaguelands"],68.08,77.53,0)
	...
	self:addLookupList(VendorDB,12956,L["Zannok Hidepiercer"],BZONE["Silithus"],81.90,16.04,0)
	...
	self:addLookupList(VendorDB,13432,L["Seersa Copperpinch"],BZONE["Thunder Bluff"],42.18,55.57,2)
	self:addLookupList(VendorDB,13433,L["Wulmort Jinglepocket"],BZONE["Ironforge"],33.08,66.93,0)
	self:addLookupList(VendorDB,13435,L["Khole Jinglepocket"],BZONE["Stormwind City"],61.90,71.29,1)
	...
	self:addLookupList(VendorDB,16670,L["Eriden"],BZONE["Silvermoon City"],80.27,39.77,2)
	...
	self:addLookupList(VendorDB,16722,L["Egomis"],BZONE["The Exodar"],39.44,39.56,1)
	...
	self:addLookupList(VendorDB,19296,L["Innkeeper Biribi"],BZONE["Ironforge"],50.92,74.38,1)
	...
	self:addLookupList(VendorDB,20028,L["Doba"],BZONE["Blade's Edge Mountains"],28.62,92.54,1)
	...
	self:addLookupList(VendorDB,27054,L["Modoru"],BZONE["Ironforge"],37.89,56.09,1)
	...
	self:addLookupList(VendorDB,28714,L["Ildine Sorrowspear"],BZONE["Dalaran"],39.21,41.01,0)
	...
	self:addLookupList(VendorDB,30431,L["Veteran Crusader Aliocha Segard"],BZONE["Icecrown"],88.03,76.76,0)
	...
	self:addLookupList(VendorDB,32287,L["Archmage Alvareaux"],BZONE["Dalaran"],26.40,47.82,0)
	self:addLookupList(VendorDB,32294,L["Knight Dameron"],BZONE["Wintergrasp"],51.40,17.54,1)
	self:addLookupList(VendorDB,32296,L["Stone Guard Mukar"],BZONE["Wintergrasp"],51.16,17.76,2)
	self:addLookupList(VendorDB,32379,L["Captain O'Neal"],BZONE["Stormwind City"],74.99,68.05,1)
	self:addLookupList(VendorDB,32382,L["Lady Palanseer"],BZONE["Orgrimmar"],37.08,64.82,2)
