...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,1347,L["Alexandra Bolero"],BZONE["Stormwind City"],53.68,80.901)
	...
	self:addLookupList(VendorDB,3367,L["Felika"],BZONE["Orgrimmar"],58.22,50.972)
	...
	self:addLookupList(VendorDB,5162,L["Tansy Puddlefizz"],BZONE["Ironforge"],47.89,6.7561)
	...
	self:addLookupList(VendorDB,8160,L["Nioma"],BZONE["The Hinterlands"],13.56,43.360)
	...
	self:addLookupList(VendorDB,16689,L["Zaralda"],BZONE["Silvermoon City"],83.98,80.782)
	...
	self:addLookupList(VendorDB,19017,L["Borto"],BZONE["Nagrand"],53.98,71.311)
