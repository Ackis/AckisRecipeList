...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,2684,L["Rizz Loosebolt"],BZONE["Alterac Mountains"],47.59,35.390)
	...
	self:addLookupList(VendorDB,4561,L["Daniel Bartlett"],BZONE["Undercity"],65.10,39.302)
	self:addLookupList(VendorDB,4574,L["Lizbeth Cromwell"],BZONE["Undercity"],81.47,31.572)
	...
	self:addLookupList(VendorDB,5494,L["Catherine Leland"],BZONE["Stormwind City"],54.99,70.261)
