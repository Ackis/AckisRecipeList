...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,5162,L["Tansy Puddlefizz"],BZONE["Ironforge"],47.90,6.681,1)
	self:addLookupList(VendorDB,5163,L["Burbik Gearspanner"],BZONE["Ironforge"],46.70,28.55,1)
	self:addLookupList(VendorDB,5175,L["Gearcutter Cogspinner"],BZONE["Ironforge"],68.62,44.96,1)
	...
	self:addLookupList(VendorDB,16689,L["Zaralda"],BZONE["Silvermoon City"],83.79,81.95,2)
	...
	self:addLookupList(VendorDB,16748,L["Haferet"],BZONE["The Exodar"],66.66,75.26,1)
	self:addLookupList(VendorDB,16767,L["Neii"],BZONE["The Exodar"],63.70,68.90,1)
