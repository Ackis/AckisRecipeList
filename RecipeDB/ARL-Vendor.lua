...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,5162,L["Tansy Puddlefizz"],BZONE["Ironforge"],48.22,5.982,1)
	self:addLookupList(VendorDB,5163,L["Burbik Gearspanner"],BZONE["Ironforge"],47.06,27.92,1)
	self:addLookupList(VendorDB,5175,L["Gearcutter Cogspinner"],BZONE["Ironforge"],68.62,45.00,1)
	self:addLookupList(VendorDB,5178,L["Soolie Berryfizz"],BZONE["Ironforge"],67.76,54.35,1)
	...
	self:addLookupList(VendorDB,5512,L["Kaita Deepforge"],BZONE["Stormwind City"],62.98,38.04,1)
	...
	self:addLookupList(VendorDB,6576,L["Brienna Starglow"],BZONE["Thousand Needles"],9.068,19.09,1)
	self:addLookupList(VendorDB,6730,L["Jinky Twizzlefixxit"],BZONE["Thousand Needles"],77.84,77.86,0)
	...
	self:addLookupList(VendorDB,7733,L["Innkeeper Fizzgrimble"],BZONE["Ironforge"],56.40,80.76,0)
	...
	self:addLookupList(VendorDB,16670,L["Eriden"],BZONE["Silvermoon City"],80.21,37.00,2)
	self:addLookupList(VendorDB,16677,L["Quelis"],BZONE["Silvermoon City"],69.44,70.15,2)
	self:addLookupList(VendorDB,16689,L["Zaralda"],BZONE["Silvermoon City"],83.94,80.38,2)
	self:addLookupList(VendorDB,16705,L["Altaa"],BZONE["The Exodar"],28.14,62.15,1)
	self:addLookupList(VendorDB,16713,L["Arras"],BZONE["The Exodar"],60.45,88.41,1)
	...
	self:addLookupList(VendorDB,20028,L["Doba"],BZONE["Blade's Edge Mountains"],28.61,92.50,1)
	...
	self:addLookupList(VendorDB,23012,L["Hotoppik Copperpinch"],BZONE["Silvermoon City"],62.89,76.65,2)
	self:addLookupList(VendorDB,23064,L["Eebee Jinglepocket"],BZONE["Shattrath City"],51.14,30.89,0)
	...
	self:addLookupList(VendorDB,26081,L["High Admiral \"Shelly\" Jorrik"],BZONE["Dun Morogh"],11.08,75.87,0)
	...
	self:addLookupList(VendorDB,30489,L["Morgan Day"],BZONE["Wintergrasp"],49.33,17.90,1)
