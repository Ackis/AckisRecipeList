...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,2668,L["Danielle Zipstitch"],BZONE["Duskwood"],75.52,46.551)
	...
	self:addLookupList(VendorDB,2698,L["George Candarte"],BZONE["Hillsbrad Foothills"],91.80,38.212)
	...
	self:addLookupList(VendorDB,3366,L["Tamar"],BZONE["Orgrimmar"],63.01,46.432)
	...
	self:addLookupList(VendorDB,3956,L["Harklan Moongrove"],BZONE["Ashenvale"],50.71,67.081)
	...
	self:addLookupList(VendorDB,4574,L["Lizbeth Cromwell"],BZONE["Undercity"],81.47,31.562)
	...
	self:addLookupList(VendorDB,4878,L["Montarr"],BZONE["Thousand Needles"],45.78,51.072)
	...
	self:addLookupList(VendorDB,5162,L["Tansy Puddlefizz"],BZONE["Ironforge"],47.89,6.7411)
	...
	self:addLookupList(VendorDB,5178,L["Soolie Berryfizz"],BZONE["Ironforge"],67.72,54.361)
	self:addLookupList(VendorDB,5483,L["Erika Tate"],BZONE["Stormwind City"],77.93,53.021)
	self:addLookupList(VendorDB,5494,L["Catherine Leland"],BZONE["Stormwind City"],55.01,70.241)
	...
	self:addLookupList(VendorDB,5758,L["Leo Sarn"],BZONE["Silverpine Forest"],54.09,82.922)
	...
	self:addLookupList(VendorDB,6576,L["Brienna Starglow"],BZONE["Thousand Needles"],9.002,18.931)
	...
	self:addLookupList(VendorDB,7733,L["Innkeeper Fizzgrimble"],BZONE["Ironforge"],56.35,80.690)
	...
	self:addLookupList(VendorDB,8150,L["Janet Hommers"],BZONE["Desolace"],65.83,7.2971)
	...
	self:addLookupList(VendorDB,11874,L["Masat T'andr"],BZONE["Swamp of Sorrows"],26.53,32.710)
	...
	self:addLookupList(VendorDB,12962,L["Wik'Tar"],BZONE["Ashenvale"],12.32,34.202)
	...
	self:addLookupList(VendorDB,16641,L["Melaris"],BZONE["Silvermoon City"],66.75,19.092)
	self:addLookupList(VendorDB,16657,L["Feera"],BZONE["The Exodar"],55.46,90.521)
	...
	self:addLookupList(VendorDB,16689,L["Zaralda"],BZONE["Silvermoon City"],83.99,80.782)
	self:addLookupList(VendorDB,16705,L["Altaa"],BZONE["The Exodar"],28.12,62.171)
	self:addLookupList(VendorDB,16713,L["Arras"],BZONE["The Exodar"],60.45,88.431)
	self:addLookupList(VendorDB,16718,L["Phea"],BZONE["The Exodar"],56.22,27.991)
	...
	self:addLookupList(VendorDB,19342,L["Krek Cragcrush"],BZONE["Shadowmoon Valley"],29.59,31.240)
	self:addLookupList(VendorDB,19351,L["Daggle Ironshaper"],BZONE["Shadowmoon Valley"],36.90,54.680)
	...
	self:addLookupList(VendorDB,32294,L["Knight Dameron"],BZONE["Wintergrasp"],51.49,17.490)
