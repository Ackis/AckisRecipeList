...
331 found from data mining.  0 ignored.
...
function addon:InitVendor(VendorDB)
	...
	self:addLookupList(VendorDB,1146,L["Vharr"],BZONE["Stranglethorn Vale"],32.85,28.77,2)
	...
	self:addLookupList(VendorDB,5162,L["Tansy Puddlefizz"],BZONE["Ironforge"],47.89,6.833,1)
	...
	self:addLookupList(VendorDB,8176,L["Gharash"],BZONE["Orgrimmar"],35.18,53.15,2)
	...
	self:addLookupList(VendorDB,13432,L["Seersa Copperpinch"],BZONE["Thunder Bluff"],42.18,55.59,2)
	...
	self:addLookupList(VendorDB,23010,L["Wolgren Jinglepocket"],BZONE["The Exodar"],54.72,47.80,1)
	self:addLookupList(VendorDB,23012,L["Hotoppik Copperpinch"],BZONE["Silvermoon City"],63.50,77.21,2)
	self:addLookupList(VendorDB,23064,L["Eebee Jinglepocket"],BZONE["Shattrath City"],51.42,31.18,0)
	...
	self:addLookupList(VendorDB,29510,L["Linna Bruder"],BZONE["Dalaran"],34.73,33.58,0)
