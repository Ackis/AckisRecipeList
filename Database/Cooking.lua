...
function addon:InitCooking()
	...
	recipe:AddTrainer(1355, 1382, 1430, 1699, 3026, 3067, 3087, 3399, 4210, 4552, 5159, 5482, 6286, 8306, 16253, 16277, 16676, 16719, 17246, 18987, 18988, 18993, 19185, 19369, 45550, 46709)
	...
	recipe:AddTrainer(2818, 45550, 46709)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(19186, 45550, 46709)
	...
	recipe:AddTrainer(26905, 26953, 26972, 26989, 28705, 29631, 33587, 45550, 46709)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE)
	recipe:AddTrainer(3399, 45550, 46709)
