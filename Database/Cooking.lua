...
function addon:InitCooking(RecipeDB)
	...
	AddRecipe(8607, 40, 6890, R_COMMON, GAME_ORIG, 40, 80, 100, 120)
	...
	-- Spice Bread -- 37836
	AddRecipe(37836, 1, 30816, R_COMMON, GAME_TBC, 1, 30, 35, 38)
	...
	AddRecipe(65454, 45, 46691, R_COMMON, GAME_WOTLK, 45, 55, 60, 65)
