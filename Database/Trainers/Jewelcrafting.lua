...
function private:InitializeJewelcraftingTrainers()
	...
	self:AddTrainer(19539, "Jazdalaad", Z.NETHERSTORM, 44.5, 34, "Neutral")
	...
	self:AddTrainer(33637, "Kirembri Silvermane", Z.SHATTRATH_CITY, 58.1, 75, "Neutral")
	self:AddTrainer(33680, "Nemiha", Z.SHATTRATH_CITY, 36.1, 47.7, "Neutral")
	self:AddTrainer(44582, "Theresa Denman", Z.STORMWIND_CITY, 63.5, 61.6, "Alliance")
	self:AddTrainer(46675, "Lugrah", Z.ORGRIMMAR, 72.49, 34.31, "Horde")
	self:AddTrainer(52586, "Hanner Gembold", Z.IRONFORGE, 51, 25.4, "Alliance")
	self:AddTrainer(52645, "Aessa Silverdew", Z.DARNASSUS, 54.2, 30.4, "Alliance")
	self:AddTrainer(52657, "Nahari Cloudchaser", Z.THUNDER_BLUFF, 35.0, 54.0, "Horde")
