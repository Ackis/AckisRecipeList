...
function private:InitializeCookingTrainers()
	self:AddTrainer(1355, "Cook Ghilm", Z.DUN_MOROGH, 75.6, 52.9, "Alliance")
	...
	self:AddTrainer(1699, "Gremlock Pilsnor", Z.DUN_MOROGH, 54.7, 50.6, "Alliance")
	self:AddTrainer(2818, "Slagg", Z.ARATHI_HIGHLANDS, 74.1, 33.8, "Horde")
	self:AddTrainer(3026, "Aska Mistrunner", Z.THUNDER_BLUFF, 50.7, 53.1, "Horde")
	...
	self:AddTrainer(4210, "Alegorn", Z.DARNASSUS, 49.9, 36.6, "Alliance")
	...
	self:AddTrainer(5482, "Stephen Ryback", Z.STORMWIND_CITY, 77.2, 53.2, "Alliance")
	self:AddTrainer(6286, "Zarrin", Z.TELDRASSIL, 56.6, 53.6, "Alliance")
	self:AddTrainer(8306, "Duhng", Z.NORTHERN_BARRENS, 55.4, 61.3, "Horde")
	self:AddTrainer(8696, "Henry Stern", Z.RAZORFEN_DOWNS, 80.6, 17, "Neutral")
	self:AddTrainer(16253, "Master Chef Mouldier", Z.GHOSTLANDS, 48.3, 30.9, "Horde")
	...
	self:AddTrainer(18993, "Naka", Z.ZANGARMARSH, 78.5, 63, "Neutral")
	...
	self:AddTrainer(42288, "Robby Flay", Z.STORMWIND_CITY, 50.39, 71.82, "Alliance")
	self:AddTrainer(42506, "Marogg", Z.ORGRIMMAR, 56.5, 62.6, "Horde")
	...
	self:AddTrainer(54232, "Mrs. Gant", Z.THE_CAPE_OF_STRANGLETHORN, 42.6, 72.8, "Neutral")
