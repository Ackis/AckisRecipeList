...
function private:InitializeBlacksmithingTrainers()
	...
	self:AddTrainer(2998, "Karn Stonehoof", Z.THUNDER_BLUFF, 39.4, 55.1, "Horde") --COMPLETELY UPDATED
	...
	self:AddTrainer(6299, "Delfrum Flintbeard", Z.DARKSHORE, 38.2, 41, "Alliance")
