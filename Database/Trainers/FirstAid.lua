...
function private:InitializeFirstAidTrainers()
	...
	self:AddTrainer(2798, "Pand Stonebinder", Z.THUNDER_BLUFF, 29.7, 21.2, "Horde") -- COMPLETELY UPDATED
	self:AddTrainer(3181, "Fremal Doohickey", Z.WETLANDS, 10.8, 61.3, "Alliance")
	self:AddTrainer(4211, "Dannelor", Z.DARNASSUS, 51.7, 30.4, "Alliance") -- COMPLETELY UPDATED
	...
	self:AddTrainer(5943, "Rawrk", Z.DUROTAR, 54.1, 42, "Horde") -- COMPLETELY UPDATED
	...
	self:AddTrainer(19478, "Fera Palerunner", Z.BLADES_EDGE_MOUNTAINS, 54, 55.1, "Horde") -- COMPLETELY UPDATED
