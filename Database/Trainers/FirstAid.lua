...
function private:InitializeFirstAidTrainers()
	...
	self:AddTrainer(12939, "Doctor Gustaf VanHowzen", Z.DUSTWALLOW_MARSH, 67.8, 49.0, "Alliance")
	...
	self:AddTrainer(64482, "Healer Nan", Z.SHRINE_OF_SEVEN_STARS, 87.8, 68.6, "Alliance")
