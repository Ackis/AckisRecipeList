...
function private:InitializeLeatherworkingTrainers()
	...
	self:AddTrainer(3007, "Una", Z.THUNDER_BLUFF, 41.5, 42.6, "Horde")
	...
	self:AddTrainer(4212, "Telonis", Z.DARNASSUS, 60.5, 36.8, "Alliance")
	...
	self:AddTrainer(5564, "Simon Tanner", Z.STORMWIND_CITY, 71.8, 62.9, "Alliance")
	...
	self:AddTrainer(21087, "Grikka", Z.BLADES_EDGE_MOUNTAINS, 76.8, 65.5, "Horde")
