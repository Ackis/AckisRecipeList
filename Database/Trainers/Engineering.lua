...
function private:InitializeEngineeringTrainers()
	...
	self:AddTrainer(5518, "Lilliam Sparkspindle", "Stormwind City", 62.8, 32, "Alliance")
	...
	self:AddTrainer(8736, "Buzzek Bracketswing", "Tanaris", 51.7, 30.4, "Neutral")
	...
	self:AddTrainer(14742, "Zap Farflinger", "Winterspring", 59.7, 49.8, "Neutral")
	self:AddTrainer(14743, "Jhordy Lapforge", "Tanaris", 52.2, 27.9, "Neutral")
	...
	self:AddTrainer(17637, "Mack Diver", "Zangarmarsh", 34, 50.8, "Horde")
