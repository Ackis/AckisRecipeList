...
function addon:InitTrainer(DB)
	...
	self:addLookupList(DB, 3355, L["Saru Steelfury"], BZ["Orgrimmar"], 82.1, 23.0, HORDE)
	...
	self:addLookupList(DB, 11177, L["Okothos Ironrager"], BZ["Orgrimmar"], 79.8, 23.8, HORDE)
	...
	self:addLookupList(DB, 46709, L["Arugi"], BZ["Orgrimmar"], 56.5, 61.5, HORDE)
	...
	self:addLookupList(DB, 47418, L["Runda"], L["Durotar"], 52.8, 42.0, HORDE)
