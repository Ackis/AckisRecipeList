...
function addon:InitSmelting()
	...
	AddRecipe(22967, 300, 17771, Q.LEGENDARY, V.ORIG, 300, 350, 362, 375)
	...
	AddRecipe(55208, 450, 37663, Q.UNCOMMON, V.WOTLK, 450, 450, 450, 450)
	...
	AddRecipe(55211, 450, 41163, Q.UNCOMMON, V.WOTLK, 450, 450, 450, 450)
