...
function addon:InitJewelcrafting()
	...
	recipe = AddRecipe(28905, 300, 23095, Q.COMMON, V.TBC, 300, 310, 315, 320)
	...
	recipe = AddRecipe(28917, 300, 23104, Q.COMMON, V.TBC, 300, 310, 315, 320)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(18751, 18774, 19063, 19539, 26915, 26960, 26982, 26997, 28701, 33590, 33614, 33680, 46675)
	...
	recipe = AddRecipe(28953, 300, 23119, Q.COMMON, V.TBC, 300, 310, 315, 320)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP, F.HEALER, F.CASTER)
	recipe:AddTrainer(18751, 18774, 19063, 19539, 26915, 26960, 26982, 26997, 28701, 33590, 33614, 33680, 46675)
	...
	recipe = AddRecipe(31048, 305, 24074, Q.COMMON, V.TBC, 305, 315, 320, 325)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP, F.DPS, F.RING)
	recipe:AddTrainer(18751, 18774, 19063, 19539, 26915, 26960, 26982, 26997, 28701, 33590, 33614, 33680, 46675)

	-- Golden Draenite Ring -- 31049
	recipe = AddRecipe(31049, 305, 24075, Q.COMMON, V.TBC, 305, 315, 320, 325)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP, F.HEALER, F.CASTER, F.RING)
	recipe:AddTrainer(18751, 18774, 19063, 19539, 26915, 26960, 26982, 26997, 28701, 33590, 33614, 33680, 46675)
	...
	recipe = AddRecipe(34590, 300, 28595, Q.COMMON, V.TBC, 300, 310, 315, 320)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP, F.DPS)
	recipe:AddTrainer(18751, 18774, 19063, 19539, 26915, 26960, 26982, 26997, 28701, 33590, 33614, 33680, 46675)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP, F.DPS)
	recipe:AddTrainer(18751, 26915, 26960, 26982, 26997, 28701, 33590, 46675)
	...
	recipe = AddRecipe(53843, 350, 39907, Q.COMMON, V.WOTLK, 350, 360, 365, 370)
	...
	recipe = AddRecipe(53891, 350, 39965, Q.COMMON, V.WOTLK, 350, 360, 365, 370)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP, F.TANK)
	recipe:AddTrainer(18751, 26915, 26960, 26982, 26997, 28701, 33590, 46675)
	...
	recipe = AddRecipe(56206, 350, 42420, Q.COMMON, V.WOTLK, 350, 360, 365, 370)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(18751, 26915, 26960, 26982, 26997, 28701, 33590, 46675)

	-- Shadow Jade Focusing Lens -- 56208
	recipe = AddRecipe(56208, 350, 42421, Q.COMMON, V.WOTLK, 350, 360, 365, 370)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(18751, 26915, 26960, 26982, 26997, 28701, 33590, 46675)
	...
	recipe = AddRecipe(56530, 350, 42701, Q.COMMON, V.WOTLK, 350, 360, 365, 370)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(18751, 26915, 26960, 26982, 26997, 28701, 33590, 46675)
	...
	recipe = AddRecipe(58143, 350, 43246, Q.COMMON, V.WOTLK, 350, 360, 365, 370)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOP, F.RBOP, F.HEALER, F.CASTER, F.RING)
	recipe:AddTrainer(18751, 26915, 26960, 26982, 26997, 28701, 33590, 46675)

	-- Jade Ring of Slaying -- 58144
	recipe = AddRecipe(58144, 350, 43247, Q.COMMON, V.WOTLK, 350, 360, 365, 370)
	...
	recipe = AddRecipe(73266, 425, 68741, Q.COMMON, V.CATA, 425, 435, 440, 445)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(18751, 18774, 19063, 19775, 19778, 26915, 26960, 26982, 26997, 28701, 33590, 33614, 44582, 46675)
