...
function addon:InitAlchemy()
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1215, 1246, 1386, 1470, 2132, 2391, 2837, 3009, 3184, 3347, 3603, 3964, 4160, 4611, 4900, 5177, 5499, 7948, 16161, 16588, 16642, 16723, 17215, 18802, 19052, 27023, 27029, 33608, 33674, 47418)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP, F.DPS)
	recipe:AddTrainer(2132, 3009, 3184, 3347, 4611, 16588, 18802, 19052, 27023, 27029, 33608, 33674)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(2132, 3009, 3184, 3347, 4611, 26903, 26951, 26975, 26987, 28703, 33588)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(2132, 3009, 3184, 3347, 4160, 4611, 5177, 5499, 28703)
	...
	recipe = AddRecipe(96252, 500, 68775, Q.EPIC, V.CATA, 500, 510, 515, 520)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOP, F.RBOP)
	recipe:AddTrainer(2132, 3009, 3184, 3347, 4160, 4611, 5177, 5499, 28703)

	-- Quicksilver Alchemist Stone -- 96253
	recipe = AddRecipe(96253, 500, 68776, Q.EPIC, V.CATA, 500, 510, 515, 520)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOP, F.RBOP)
	recipe:AddTrainer(2132, 3009, 3184, 3347, 4160, 4611, 5177, 5499, 28703)

	-- Vibrant Alchemist Stone -- 96254
	recipe = AddRecipe(96254, 500, 68777, Q.EPIC, V.CATA, 500, 510, 515, 520)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOP, F.RBOP)
	recipe:AddTrainer(2132, 3009, 3184, 3347, 4160, 4611, 5177, 5499, 28703)
