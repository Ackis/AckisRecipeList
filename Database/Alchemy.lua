...
function addon:InitAlchemy()
	...
	self:AddRecipeFlags(47046, F.ALLIANCE, F.HORDE, F.QUEST, F.IBOP, F.RBOP, F.TANK, F.TRINKET, F.SHATTEREDSUN)
	...
	self:AddRecipeFlags(47048, F.ALLIANCE, F.HORDE, F.QUEST, F.IBOP, F.RBOP, F.HEALER, F.CASTER, F.TRINKET, F.SHATTEREDSUN)
	...
	self:AddRecipeFlags(47049, F.ALLIANCE, F.HORDE, F.QUEST, F.IBOP, F.RBOP, F.HEALER, F.CASTER, F.TRINKET, F.SHATTEREDSUN)
	...
	self:AddRecipeFlags(47050, F.ALLIANCE, F.HORDE, F.QUEST, F.IBOP, F.RBOP, F.DPS, F.TRINKET, F.SHATTEREDSUN)
