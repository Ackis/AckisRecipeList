...
function addon:InitBlacksmithing()
	...
	recipe:SetItemFilterType("BLACKSMITHING_WRIST")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.IBOE, F.RBOP, F.TANK, F.REPUTATION, F.ALDOR)
	...
	recipe:SetSkillLevels(355, 355, 365, 375, 385)
	recipe:SetItemFilterType("BLACKSMITHING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.IBOE, F.RBOP, F.DPS, F.TANK, F.CASTER, F.REPUTATION, F.ALDOR)
	...
	recipe:SetRecipeItemID(84196)
	recipe:SetCraftedItemID(90046)
	...
	recipe:SetRecipeItemID(84208)
	recipe:SetCraftedItemID(82968)
	...
	recipe:SetRecipeItemID(84226)
	recipe:SetCraftedItemID(82969)
	recipe:SetSkillLevels(575, 575, 600, 602, 605)
	recipe:SetItemFilterType("BLACKSMITHING_SHIELD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.DPS, F.TANK)
	recipe:AddVendor(64058, 64085)
	...
	recipe:SetRecipeItemID(84197)
	recipe:SetCraftedItemID(82970)
	recipe:SetSkillLevels(575, 575, 600, 602, 605)
	recipe:SetItemFilterType("BLACKSMITHING_ONE_HAND_AXE")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.HEALER, F.CASTER, F.REPUTATION, F.KLAXXI)
	recipe:AddRepVendor(FAC.KLAXXI, REP.HONORED, 64599)

	-- Masterwork Ghost-Forged Blade -- 122645
	recipe = AddRecipe(122645, V.MOP, Q.COMMON)
	recipe:SetRecipeItemID(84200)
	recipe:SetCraftedItemID(82971)
	recipe:SetSkillLevels(575, 575, 600, 602, 605)
	recipe:SetItemFilterType("BLACKSMITHING_ONE_HAND_SWORD")
	...
	recipe:SetRecipeItemID(84217)
	recipe:SetCraftedItemID(82972)
	recipe:SetSkillLevels(575, 575, 600, 602, 605)
	recipe:SetItemFilterType("BLACKSMITHING_ONE_HAND_MACE")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.DPS, F.HEALER, F.CASTER, F.REPUTATION, F.KLAXXI)
	recipe:AddRepVendor(FAC.KLAXXI, REP.HONORED, 64599)
	...
	recipe:SetRecipeItemID(83787)
	recipe:SetCraftedItemID(82975)
	recipe:SetSkillLevels(600, 600, 600, 602, 605)
	recipe:SetItemFilterType("BLACKSMITHING_CHEST")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.DPS, F.HEALER, F.CASTER, F.REPUTATION, F.KLAXXI)
	recipe:AddRepVendor(FAC.KLAXXI, REP.HONORED, 64599)
	...
	recipe:SetRecipeItemID(83788)
	recipe:SetCraftedItemID(82976)
	recipe:SetSkillLevels(600, 600, 600, 602, 605)
	recipe:SetItemFilterType("BLACKSMITHING_HANDS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.DPS, F.HEALER, F.CASTER, F.REPUTATION, F.KLAXXI)
	recipe:AddRepVendor(FAC.KLAXXI, REP.HONORED, 64599)
	...
	recipe:SetRecipeItemID(83789)
	recipe:SetCraftedItemID(82977)
	recipe:SetSkillLevels(600, 600, 600, 602, 605)
	recipe:SetItemFilterType("BLACKSMITHING_CHEST")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.HEALER, F.CASTER, F.REPUTATION, F.KLAXXI)
	recipe:AddRepVendor(FAC.KLAXXI, REP.HONORED, 64599)
	...
	recipe:SetRecipeItemID(83790)
	recipe:SetCraftedItemID(82978)
	recipe:SetSkillLevels(600, 600, 600, 602, 605)
	recipe:SetItemFilterType("BLACKSMITHING_CHEST")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.HEALER, F.CASTER, F.REPUTATION, F.KLAXXI)
	recipe:AddRepVendor(FAC.KLAXXI, REP.HONORED, 64599)
	...
	recipe:SetRecipeItemID(83791)
	recipe:SetCraftedItemID(82979)
	recipe:SetSkillLevels(600, 600, 600, 602, 605)
	recipe:SetItemFilterType("BLACKSMITHING_CHEST")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.DPS, F.TANK, F.REPUTATION, F.KLAXXI)
	recipe:AddRepVendor(FAC.KLAXXI, REP.HONORED, 64599)

	-- Gauntlets of Ancient Steel -- 122654
	recipe = AddRecipe(122654, V.MOP, Q.COMMON)
	recipe:SetRecipeItemID(83792)
	recipe:SetCraftedItemID(82980)
	recipe:SetSkillLevels(600, 600, 600, 602, 605)
	recipe:SetItemFilterType("BLACKSMITHING_HANDS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.DPS, F.TANK, F.REPUTATION, F.KLAXXI)
	recipe:AddRepVendor(FAC.KLAXXI, REP.HONORED, 64599)
	...
	recipe:SetRecipeItemID(87408)
	recipe:SetCraftedItemID(87405)
	recipe:SetSkillLevels(600, 600, 605, 610, 615)
	recipe:SetItemFilterType("BLACKSMITHING_HANDS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.RAID, F.IBOE, F.RBOE, F.TANK)
	recipe:AddCustom("MOP_RAIDS_RANDOM")

	-- Gauntlets of Battle Command -- 126851
	recipe = AddRecipe(126851, V.MOP, Q.EPIC)
	recipe:SetRecipeItemID(87409)
	recipe:SetCraftedItemID(87406)
	recipe:SetSkillLevels(600, 600, 605, 610, 615)
	recipe:SetItemFilterType("BLACKSMITHING_HANDS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.RAID, F.IBOE, F.RBOE, F.DPS, F.TANK)
	recipe:AddCustom("MOP_RAIDS_RANDOM")
	...
	recipe:SetRecipeItemID(87410)
	recipe:SetCraftedItemID(87402)
	recipe:SetSkillLevels(600, 600, 605, 610, 615)
	recipe:SetItemFilterType("BLACKSMITHING_CHEST")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.RAID, F.IBOE, F.RBOE, F.DPS, F.TANK)
	recipe:AddCustom("MOP_RAIDS_RANDOM")
	...
	recipe:SetRecipeItemID(87411)
	recipe:SetCraftedItemID(87407)
	recipe:SetSkillLevels(600, 600, 605, 610, 615)
	recipe:SetItemFilterType("BLACKSMITHING_HANDS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.RAID, F.IBOE, F.RBOE, F.DPS, F.HEALER, F.CASTER)
	recipe:AddCustom("MOP_RAIDS_RANDOM")
	...
	recipe:SetRecipeItemID(90531)
	recipe:SetCraftedItemID(86599)
	recipe:SetSkillLevels(540, 540, 550, 557, 565)
	recipe:SetItemFilterType("BLACKSMITHING_ITEM_ENHANCEMENT")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOE, F.REPUTATION, F.KLAXXI)
	recipe:AddRepVendor(FAC.KLAXXI, REP.HONORED, 64599)

	-- Living Steel Weapon Chain -- 131929
	recipe = AddRecipe(131929, V.MOP, Q.COMMON)
	recipe:SetRecipeItemID(90532)
	recipe:SetCraftedItemID(86597)
	recipe:SetSkillLevels(540, 540, 600, 602, 605)
	recipe:SetItemFilterType("BLACKSMITHING_ITEM_ENHANCEMENT")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOE, F.DPS, F.TANK, F.REPUTATION, F.KLAXXI)
	recipe:AddRepVendor(FAC.KLAXXI, REP.HONORED, 64599)
