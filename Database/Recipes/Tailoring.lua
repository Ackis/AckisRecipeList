...
function addon:InitTailoring()
	...
	recipe:SetSkillLevels(300, 300, 315, 330, 345)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.WORLD_DROP, F.IBOE, F.RBOE, F.HEALER, F.CASTER, F.MAGE, F.PRIEST, F.WARLOCK)
	recipe:SetItemFilterType("TAILORING_HANDS")
	recipe:AddWorldDrop("Eastern Kingdoms", "Kalimdor")
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.RAID, F.IBOE, F.RBOE, F.HEALER)
	recipe:SetItemFilterType("TAILORING_HANDS")
	...
	recipe:SetSkillLevels(525, 525, 525, 527, 530)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.RAID, F.IBOE, F.RBOE, F.CASTER)
	recipe:SetItemFilterType("TAILORING_HANDS")
	recipe:AddCustom("FIRELANDS_RANDOM")
