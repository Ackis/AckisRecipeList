...
function addon:InitTailoring()
	...
	recipe:AddTrainer(1103, 1346, 2399, 2627, 3004, 3363, 3484, 3523, 3704, 4159, 4193, 4576, 5153, 9584, 11052, 11557, 16366, 16640, 16729, 17487, 18749, 18772, 26914, 26964, 26969, 27001, 28699, 33580, 33613, 33636, 33684, 44783, 45559, 47384, 47396, 47418, 47420, 47431, 57405)
	...
	recipe:SetItemFilterType("TAILORING_LEGS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.HEALER, F.CASTER)
	recipe:AddTrainer(1346, 2399, 3004, 3363, 4159, 4576, 4578, 5153, 9584, 16729, 18772, 26914, 27001, 33580, 33613, 33636, 44783, 45559, 57405)
	...
	recipe:SetItemFilterType("TAILORING_MATERIALS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(1346, 2399, 3004, 3363, 4159, 4576, 5153, 9584, 16729, 18749, 18772, 26914, 26964, 26969, 27001, 28699, 33580, 33613, 33636, 33684, 44783, 45559, 57405)
	...
	recipe:SetItemFilterType("TAILORING_ITEM_ENHANCEMENT")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.HEALER, F.CASTER)
	recipe:AddTrainer(1346, 2399, 3004, 3363, 4159, 4576, 5153, 9584, 16729, 18772, 26914, 26964, 26969, 27001, 28699, 33580, 33613, 33636, 44783, 45559, 57405)
	...
	recipe:SetItemFilterType("TAILORING_MATERIALS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(1346, 2399, 3004, 3363, 4159, 4576, 5153, 9584, 16640, 16729, 18772, 26914, 27001, 28699, 33580, 33613, 33636, 44783, 45559, 57405)
	...
	recipe:SetItemFilterType("TAILORING_WAIST")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(1346, 2399, 3004, 3363, 4159, 4576, 5153, 9584, 16640, 28699, 33580, 33613, 33636, 44783, 45559, 57405)
	...
	recipe:SetItemFilterType("TAILORING_BACK")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(1346, 3363, 4576, 45559, 57405)
	...
	recipe:SetItemFilterType("TAILORING_HANDS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.HEALER, F.CASTER)
	recipe:AddTrainer(1346, 3363, 57405)
	...
	recipe:SetItemFilterType("TAILORING_BACK")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.HUNTER, F.ROGUE, F.SHAMAN, F.MONK, F.DRUID)
	...
	recipe:SetItemFilterType("TAILORING_BACK")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.PALADIN, F.PRIEST, F.SHAMAN, F.MAGE, F.WARLOCK, F.MONK, F.DRUID)
	recipe:AddDiscovery("DISCOVERY_TAILOR_PANDARIA")
	...
	recipe:SetItemFilterType("TAILORING_BACK")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.PALADIN, F.PRIEST, F.SHAMAN, F.MONK, F.DRUID)
	recipe:AddDiscovery("DISCOVERY_TAILOR_PANDARIA")
