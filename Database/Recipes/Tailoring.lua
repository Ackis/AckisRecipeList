...
function addon:InitTailoring()
	...
	recipe:SetItemFilterType("TAILORING_LEGS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP, F.HEALER, F.CASTER)
	recipe:AddTrainer(1346, 2399, 3004, 3363, 4159, 4578, 5153, 9584, 16729, 18772, 26914, 27001, 33580, 33613, 33636, 44783, 45559)
	...
	recipe:SetItemFilterType("TAILORING_MATERIALS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1346, 2399, 3004, 3363, 4159, 5153, 9584, 16729, 18749, 18772, 26914, 26964, 26969, 27001, 28699, 33580, 33613, 33636, 33684, 44783, 45559)
	...
	recipe:SetItemFilterType("TAILORING_ITEM_ENHANCEMENT")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP, F.HEALER, F.CASTER)
	recipe:AddTrainer(1346, 2399, 3004, 3363, 4159, 5153, 9584, 16729, 18772, 26914, 26964, 26969, 27001, 28699, 33580, 33613, 33636, 44783, 45559)
	...
	recipe:SetItemFilterType("TAILORING_BACK")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1346, 3363, 45559)
