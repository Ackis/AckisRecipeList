...
function addon:InitInscription()
	...
	recipe:AddTrainer(26916, 26959, 26977, 26995, 28702, 30706, 30709, 30710, 30711, 30713, 30715, 30716, 30717, 30721, 30722, 33603, 33615, 33638, 33679, 46716, 56065, 62327, 64691, 66355)
	...
	recipe:SetItemFilterType("INSCRIPTION_SCROLL")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(26916, 26959, 26977, 26995, 28702, 30706, 30709, 30710, 30711, 30713, 30715, 30716, 30717, 30721, 30722, 33603, 33615, 33638, 33679, 46716, 47384, 47396, 47400, 47418, 47419, 47420, 47431, 48619, 56065, 57620, 62327, 64691, 65043, 66355)
	...
	recipe:SetItemFilterType("INSCRIPTION_SCROLL")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(26916, 26959, 26977, 26995, 28702, 30706, 30709, 30713, 30715, 30716, 30717, 30721, 33603, 33615, 33638, 46716, 56065, 62327, 64691, 66355)
	...
	recipe:SetItemFilterType("INSCRIPTION_MAJOR_GLYPH")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.DRUID)
	recipe:AddTrainer(26916, 26959, 26977, 26995, 28702, 30706, 30709, 30713, 30715, 30716, 30717, 30721, 30722, 33603, 33615, 33638, 33679, 46716, 56065, 62327, 64691, 66355)
	...
	recipe:SetItemFilterType("INSCRIPTION_MINOR_GLYPH")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.MAGE)
	recipe:AddTrainer(30709, 30713, 30715, 30717, 33603, 46716, 56065, 62327, 64691, 66355)
	...
	recipe:SetItemFilterType("INSCRIPTION_MAJOR_GLYPH")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.PALADIN)
	recipe:AddTrainer(26916, 26977, 26995, 28702, 30706, 30709, 30713, 30715, 30716, 30717, 30721, 33603, 33615, 33638, 46716, 56065, 62327, 64691, 66355)
	recipe:AddDiscovery("DISCOVERY_INSC_NORTHREND", "DISCOVERY_INSC_PANDARIA")
	...
	recipe:SetItemFilterType("INSCRIPTION_CREATED_ITEM")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(26916, 26959, 26977, 26995, 28702, 30706, 30709, 30713, 30715, 30716, 30717, 30721, 33603, 33615, 33638, 33679, 46716, 56065, 62327, 64691, 66355)
	...
	recipe:SetItemFilterType("INSCRIPTION_MAJOR_GLYPH")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.DRUID)
	recipe:AddTrainer(26916, 26959, 26977, 26995, 28702, 30706, 30709, 30710, 30713, 30715, 30716, 30717, 30721, 30722, 33603, 33615, 33638, 33679, 46716, 56065, 62327, 64691, 66355)
	...
	recipe:SetItemFilterType("INSCRIPTION_SCROLL")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(26916, 26977, 26995, 28702, 30706, 30709, 30711, 30713, 30715, 30716, 30717, 30721, 33603, 33615, 33638, 46716, 56065, 62327, 64691, 66355)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(26916, 26995, 28702, 30706, 30709, 30711, 30713, 30715, 30716, 30717, 30721, 33603, 33615, 33638, 46716, 56065, 62327, 64691, 66355)
	...
	recipe:AddTrainer(30709, 30715, 30717, 33603, 66355)
	...
	recipe:AddTrainer(30709, 30713, 30715, 30717, 33603, 66355)
