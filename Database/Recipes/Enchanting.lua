...
function addon:InitEnchanting()
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOE)
	recipe:AddTrainer(1317, 3011, 3345, 3606, 4213, 4616, 5157, 5695, 7949, 11072, 11073, 11074, 16160, 16633, 16725, 18753, 18773, 19251, 19252, 19540, 26906, 26990, 28693, 33583, 33610, 33633, 33676, 65127)
	...
	recipe:SetRecipeItemID(84559)
	recipe:SetSkillLevels(600, 600, 600, 600, 615)
	recipe:SetItemFilterType("ENCHANTING_BRACER")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.HEALER, F.CASTER, F.REPUTATION, F.AUGUSTCELESTIALS)
	...
	recipe:SetRecipeItemID(84561)
	recipe:SetSkillLevels(600, 600, 600, 600, 615)
	recipe:SetItemFilterType("ENCHANTING_BRACER")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.DPS, F.REPUTATION, F.AUGUSTCELESTIALS)
	recipe:AddRepVendor(FAC.AUGUSTCELESTIALS, REP.REVERED, 64001, 64032)

	-- Enchant Bracer - Greater Agility -- 104391
	recipe = AddRecipe(104391, V.MOP, Q.RARE)
	recipe:SetRecipeItemID(84557)
	recipe:SetSkillLevels(600, 600, 600, 600, 615)
	recipe:SetItemFilterType("ENCHANTING_BRACER")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.DPS, F.REPUTATION, F.AUGUSTCELESTIALS)
	recipe:AddRepVendor(FAC.AUGUSTCELESTIALS, REP.REVERED, 64001, 64032)
	...
	recipe:SetRecipeItemID(84583)
	recipe:SetSkillLevels(600, 600, 600, 600, 615)
	recipe:SetItemFilterType("ENCHANTING_WEAPON")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.REPUTATION, F.SHADOPAN)
	...
	recipe:SetRecipeItemID(84584)
	recipe:SetSkillLevels(600, 600, 600, 600, 615)
	recipe:SetItemFilterType("ENCHANTING_WEAPON")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.DPS, F.REPUTATION, F.SHADOPAN)
	recipe:AddRepVendor(FAC.SHADOPAN, REP.REVERED, 64595)
	...
	recipe:SetRecipeItemID(84580)
	recipe:SetSkillLevels(600, 600, 600, 600, 615)
	recipe:SetItemFilterType("ENCHANTING_WEAPON")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.TANK, F.REPUTATION, F.SHADOPAN)
	recipe:AddRepVendor(FAC.SHADOPAN, REP.REVERED, 64595)
