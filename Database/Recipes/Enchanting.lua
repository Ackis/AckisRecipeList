...
function addon:InitEnchanting()
	...
	recipe:SetSkillLevels(300, 300, 310, 325, 340)
	recipe:SetItemFilterType("ENCHANTING_GLOVES")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.REPUTATION, F.RAID, F.IBOE, F.RBOP, F.DPS, F.KOT)
	...
	recipe:SetItemFilterType("ENCHANTING_BRACER")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.IBOE, F.RBOP, F.HEALER, F.CASTER, F.REPUTATION, F.HELLFIRE)
	...
	recipe:SetItemFilterType("ENCHANTING_BRACER")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.IBOE, F.RBOP, F.HEALER, F.CASTER, F.REPUTATION, F.AUGUSTCELESTIALS)
	...
	recipe:SetSkillLevels(600, 600, 600, 600, 615)
	recipe:SetItemFilterType("ENCHANTING_BRACER")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.IBOE, F.RBOP, F.DPS, F.REPUTATION, F.AUGUSTCELESTIALS)
	recipe:AddRepVendor(FAC.AUGUSTCELESTIALS, REP.REVERED, 64001, 64032)
	...
	recipe:SetSkillLevels(600, 600, 600, 600, 615)
	recipe:SetItemFilterType("ENCHANTING_WEAPON")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.IBOE, F.RBOP, F.REPUTATION, F.SHADOPAN)
	...
	recipe:SetSkillLevels(600, 600, 600, 600, 615)
	recipe:SetItemFilterType("ENCHANTING_WEAPON")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.IBOE, F.RBOP, F.DPS, F.REPUTATION, F.SHADOPAN)
	recipe:AddRepVendor(FAC.SHADOPAN, REP.REVERED, 64595)
	...
	recipe:SetSkillLevels(600, 600, 600, 600, 615)
	recipe:SetItemFilterType("ENCHANTING_WEAPON")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.IBOE, F.RBOP, F.TANK, F.REPUTATION, F.SHADOPAN)
	recipe:AddRepVendor(FAC.SHADOPAN, REP.REVERED, 64595)
