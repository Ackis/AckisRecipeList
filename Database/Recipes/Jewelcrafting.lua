...
function addon:InitJewelcrafting()
	...
	recipe:SetSkillLevels(120, 120, 150, 165, 180)
	recipe:SetItemFilterType("JEWELCRAFTING_NECK")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.VENDOR, F.IBOE, F.RBOE, F.DPS, F.TANK)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.IBOE, F.RBOP, F.DPS, F.HEALER, F.CASTER, F.REPUTATION, F.ALDOR)
	...
	recipe:SetSkillLevels(360, 360, 370, 375, 380)
	recipe:SetItemFilterType("JEWELCRAFTING_NECK")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.IBOE, F.RBOP, F.REPUTATION, F.ALDOR)
