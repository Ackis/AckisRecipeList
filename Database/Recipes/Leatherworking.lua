...
function addon:InitLeatherworking()
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1385, 1632, 3007, 3365, 3549, 3605, 3967, 4212, 4588, 5127, 5564, 5784, 8153, 11097, 11098, 16278, 16688, 16728, 17442, 18754, 18771, 19187, 21087, 29509, 33581, 33612, 33635, 33681)
	...
	recipe:SetItemFilterType("LEATHERWORKING_WAIST")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP, F.DPS)
	recipe:AddTrainer(1385, 1632, 3007, 3365, 3549, 3605, 3967, 4212, 4588, 5127, 5564, 5784, 8153, 11097, 11098, 16278, 16688, 16728, 18754, 18771, 19187, 21087, 29509, 33581, 33612, 33635, 33681)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP, F.DPS)
	recipe:AddTrainer(1385, 1632, 3007, 3365, 3549, 3605, 3967, 4212, 4588, 5127, 5564, 5784, 8153, 11097, 11098, 16278, 16688, 16728, 17442, 18754, 18771, 19187, 21087, 29509, 33581, 33612, 33635)
	...
	recipe:SetItemFilterType("LEATHERWORKING_WRIST")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1385, 1632, 3007, 3365, 3549, 3605, 3967, 4212, 4588, 5127, 5564, 5784, 8153, 11097, 11098, 16278, 16728, 17442, 18754, 18771, 19187, 21087, 29509, 33581, 33612, 33635, 33681)
	...
	recipe:SetItemFilterType("LEATHERWORKING_LEGS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP, F.HEALER, F.CASTER)
	recipe:AddTrainer(1385, 1632, 3007, 3365, 3549, 3967, 4212, 4588, 5127, 5564, 5784, 8153, 11097, 11098, 16278, 16688, 16728, 17442, 18754, 18771, 19187, 21087, 29509, 33581, 33612, 33635, 33681)
	...
	recipe:SetItemFilterType("LEATHERWORKING_HANDS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP, F.DPS)
	recipe:AddTrainer(3365, 4212, 5564, 7868, 7869, 21087, 29507, 29509, 33581, 33612, 33635)
	...
	recipe:SetItemFilterType("LEATHERWORKING_CHEST")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(3365, 4212, 5564, 21087, 29508, 29509, 33581, 33612, 33635)
	...
	recipe:SetItemFilterType("LEATHERWORKING_ITEM_ENHANCEMENT")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1385, 1632, 3007, 3365, 3549, 3605, 3967, 4212, 4588, 5127, 5564, 5784, 8153, 11097, 11098, 16688, 16728, 17442, 18754, 18771, 19187, 21087, 29509, 33581, 33612, 33635, 33681)
	...
	recipe:SetItemFilterType("LEATHERWORKING_LEGS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOE, F.HEALER, F.CASTER)
	recipe:AddTrainer(1385, 1632, 3007, 3365, 3549, 3605, 3967, 4212, 4588, 5564, 5784, 8153, 11097, 11098, 16278, 16688, 16728, 17442, 18754, 18771, 19187, 21087, 29509, 33581, 33612, 33635, 33681)
	...
	recipe:SetSkillLevels(290, 290, 310, 320, 330)
	recipe:SetItemFilterType("LEATHERWORKING_FEET")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.DPS, F.CASTER, F.ARGENTDAWN)
	...
	recipe:SetItemFilterType("LEATHERWORKING_MATERIALS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(3365, 4212, 5564, 18754, 18771, 19187, 21087, 29509, 33581, 33612, 33635, 33681)
	...
	recipe:SetItemFilterType("LEATHERWORKING_MATERIALS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOE)
	recipe:AddTrainer(3365, 4212, 5564, 21087, 28700, 29509, 33581, 33612, 33635)
	...
	recipe:SetItemFilterType("LEATHERWORKING_HANDS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.DPS, F.TANK, F.HEALER, F.CASTER, F.CONSORTIUM)
	...
	recipe:SetSkillLevels(340, 340, 350, 360, 370)
	recipe:SetItemFilterType("LEATHERWORKING_WAIST")
	recipe:AddFilters(F.ALLIANCE, F.VENDOR, F.IBOE, F.RBOP, F.DPS, F.HEALER, F.CASTER, F.NAGRAND)
	...
	recipe:SetSkillLevels(360, 360, 370, 380, 390)
	recipe:SetItemFilterType("LEATHERWORKING_BACK")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.DPS, F.HEALER, F.CASTER, F.VIOLETEYE)
	...
	recipe:SetSkillLevels(365, 365, 375, 385, 395)
	recipe:SetItemFilterType("LEATHERWORKING_CHEST")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.DPS, F.CASTER, F.VIOLETEYE)
	...
	recipe:SetSkillLevels(450, 450, 460, 465, 470)
	recipe:SetItemFilterType("LEATHERWORKING_FEET")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.VENDOR, F.IBOE, F.RBOP, F.DPS, F.TANK, F.HEALER, F.CASTER, F.ASHEN_VERDICT)
	recipe:AddRepVendor(FAC.ASHEN_VERDICT, REP.HONORED, 37687)
