...
function addon:InitAlchemy()
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(2132, 3009, 3184, 3347, 3603, 4160, 5177, 5499, 16723, 18802, 19052, 26903, 26987, 28703, 33588, 33608, 33630, 56777, 65186)
	...
	recipe:SetItemFilterType("ALCHEMY_POTION")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(2132, 3009, 3184, 3347, 4160, 5177, 5499, 33588, 65186)
