...
function addon:InitEngineering()
	...
	recipe:SetItemFilterType("ENGINEERING_MATERIALS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1676, 1702, 3290, 3494, 5174, 5518, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 17634, 17637, 18752, 18775, 19576, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 45545, 47384, 47396, 47418, 47420, 47431, 52636, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1676, 1702, 3290, 3494, 5174, 5518, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 17634, 17637, 18752, 18775, 19576, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:AddTrainer(1702, 3494, 5174, 11017, 16726, 17222, 17634, 26907, 26991, 28697, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1676, 1702, 3290, 3494, 5174, 5518, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 17634, 17637, 18752, 18775, 19576, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_ITEM_ENHANCEMENT")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOE)
	recipe:AddTrainer(1702, 5174, 11017, 16726, 17222, 17634, 26907, 26991, 28697, 33611, 33634, 52636, 55143)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1702, 5174, 8126, 11017, 16726, 17222, 17634, 26907, 26991, 28697, 29513, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_TRINKET")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1702, 5174, 8126, 8738, 11017, 16726, 17222, 17634, 26907, 26991, 28697, 29513, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_TRINKET")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOP, F.RBOP)
	recipe:AddTrainer(1702, 5174, 7406, 7944, 11017, 16726, 17222, 17634, 26907, 26991, 28697, 29514, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_MATERIALS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1702, 3494, 5174, 5518, 8736, 11017, 11025, 16726, 17222, 17634, 17637, 18752, 18775, 19576, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:AddTrainer(1702, 5174, 5518, 17634, 17637, 18752, 18775, 19576, 25277, 26955, 28697, 33586, 45545)
	...
	recipe:SetSkillLevels(350, 350, 370, 380, 390)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOP, F.RBOP, F.PALADIN)
	recipe:AddTrainer(1702, 5174, 5518, 17634, 17637, 18752, 18775, 19576, 25277, 26907, 26955, 26991, 28697, 33586)
	...
	recipe:AddTrainer(1702, 5174, 5518, 17634, 17637, 18752, 18775, 19576, 25277, 26907, 26955, 26991, 28697, 33586, 45545)
	...
	recipe:SetSkillLevels(350, 350, 370, 380, 390)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOP, F.RBOP, F.HUNTER, F.SHAMAN)
	...
	recipe:SetSkillLevels(350, 350, 370, 380, 390)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOP, F.RBOP, F.SHAMAN)
	recipe:AddTrainer(17634, 17637, 18752, 18775, 19576, 25277, 26907, 26955, 26991, 28697, 33586)
	...
	recipe:SetSkillLevels(350, 350, 370, 380, 390)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOP, F.RBOP, F.DRUID, F.ROGUE)
	recipe:AddTrainer(17634, 17637, 18752, 18775, 19576, 25277, 26907, 26955, 26991, 28697, 33586)
	...
	recipe:SetSkillLevels(350, 350, 370, 380, 390)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOP, F.RBOP, F.DRUID)
	recipe:AddTrainer(17634, 17637, 18752, 18775, 19576, 25277, 26907, 26955, 26991, 28697, 33586)
	...
	recipe:SetSkillLevels(350, 350, 370, 380, 390)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOP, F.RBOP, F.MAGE, F.PRIEST, F.WARLOCK)
	recipe:AddTrainer(3494, 8736, 11017, 11025, 16726, 17222, 17634, 17637, 18752, 18775, 19576, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetSkillLevels(350, 350, 370, 380, 390)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOP, F.RBOP, F.PRIEST)
	recipe:AddTrainer(17634, 17637, 18752, 18775, 19576, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 52636, 55143)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1702, 3494, 5174, 5518, 8736, 11017, 11025, 16726, 17222, 17634, 17637, 24868, 25099, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_MOUNT")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1702, 3494, 5174, 5518, 8736, 11017, 11025, 16726, 17222, 17634, 17637, 24868, 25099, 26907, 26991, 28697, 33586, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.RAID, F.IBOP, F.RBOP, F.DRUID)
	...
	recipe:SetSkillLevels(375, 375, 390, 410, 430)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.RAID, F.IBOP, F.RBOE, F.DPS, F.HEALER, F.CASTER, F.PALADIN)
	recipe:AddCustom("SUNWELL_RANDOM")
	...
	recipe:SetSkillLevels(375, 375, 390, 410, 430)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.RAID, F.IBOP, F.RBOE, F.HEALER, F.CASTER, F.PRIEST)
	recipe:AddCustom("SUNWELL_RANDOM")
	...
	recipe:SetSkillLevels(375, 375, 390, 410, 430)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.RAID, F.IBOP, F.RBOP, F.SHAMAN)
	recipe:AddCustom("SUNWELL_RANDOM")
	...
	recipe:SetSkillLevels(375, 375, 390, 410, 430)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.RAID, F.IBOP, F.RBOP, F.MAGE, F.PRIEST, F.WARLOCK)
	recipe:AddCustom("SUNWELL_RANDOM")
	...
	recipe:SetSkillLevels(375, 375, 390, 410, 430)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.RAID, F.IBOP, F.RBOP, F.HUNTER, F.SHAMAN)
	recipe:AddCustom("SUNWELL_RANDOM")
	...
	recipe:SetSkillLevels(375, 375, 390, 410, 430)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.RAID, F.IBOP, F.RBOP, F.TANK, F.PALADIN, F.WARRIOR)
	recipe:AddCustom("SUNWELL_RANDOM")
	...
	recipe:SetSkillLevels(375, 375, 390, 410, 430)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.RAID, F.IBOP, F.RBOP, F.DRUID, F.ROGUE)
	recipe:AddCustom("SUNWELL_RANDOM")
	...
	recipe:AddTrainer(3494, 8736, 11017, 11025, 16726, 17222, 17634, 17637, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(11017, 25277, 26907, 26955, 26991, 28697, 33586, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1702, 5174, 11017, 16726, 17222, 17634, 26907, 26955, 26991, 28697, 29514, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:AddTrainer(1702, 5174, 5518, 25277, 26907, 26955, 26991, 28697, 33586, 45545)
	...
	recipe:SetSkillLevels(440, 440, 450, 455, 460)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOP, F.RBOP, F.HEALER, F.CASTER, F.MAGE, F.PRIEST, F.WARLOCK)
	recipe:AddTrainer(3494, 8736, 11017, 11025, 16726, 17222, 17634, 17637, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1702, 5174, 11017, 16726, 17222, 17634, 25277, 26907, 26991, 28697, 29513, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_MOUNT")
	recipe:AddFilters(F.ALLIANCE, F.IBOE, F.RBOP, F.REPUTATION, F.WRATHCOMMON1)
	...
	recipe:AddTrainer(1702, 5174, 5518, 11017, 25277, 26907, 26955, 26991, 28697, 33586, 45545, 55143)
	...
	recipe:AddTrainer(1702, 5174, 5518, 25277, 26907, 26955)
	...
	recipe:SetItemFilterType("ENGINEERING_TRINKET")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1676, 1702, 3290, 3494, 5174, 5518, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 17634, 17637, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:AddTrainer(1702, 5174, 5518, 11017, 45545)
	...
	recipe:AddTrainer(1702, 5174, 5518, 11017)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP, F.MAGE, F.PRIEST, F.WARLOCK)
	recipe:AddTrainer(3494, 5518, 8736, 11017, 11025, 16726, 17222, 17634, 17637, 26907, 26991, 28697, 33586, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_MATERIALS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1702, 3494, 5174, 5518, 8736, 11017, 11025, 16726, 17222, 17634, 17637, 26907, 26991, 28697, 33586, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_PET")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1702, 5174, 11017, 16726, 17222, 17634, 26907, 26991, 28697, 29513, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_PET")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(1702, 5174, 7944, 11017, 16726, 17222, 17634, 26907, 26991, 28697, 29514, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetSkillLevels(550, 550, 560, 565, 570)
	recipe:SetItemFilterType("ENGINEERING_ITEM_ENHANCEMENT")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.RBOP, F.TANK)
	recipe:AddTrainer(11017, 55143)
	...
	recipe:SetCraftedItemID(77529)
	recipe:SetSkillLevels(560, 560, 570, 575, 580)
	recipe:SetItemFilterType("ENGINEERING_ITEM_ENHANCEMENT")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.RBOP, F.DPS)
	recipe:AddTrainer(11017, 55143)
