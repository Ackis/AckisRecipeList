...
function addon:InitEngineering()
	...
	recipe:AddTrainer(3494, 5174, 11017, 45545)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(5174, 8126, 11017, 29513, 45545)
	...
	recipe:AddLimitedVendor(5175, 1)
	...
	recipe:SetItemFilterType("ENGINEERING_TRINKET")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(5174, 8126, 8738, 11017, 29513, 45545)
	...
	recipe:SetItemFilterType("ENGINEERING_TRINKET")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOP, F.RBOP)
	recipe:AddTrainer(5174, 7406, 7944, 11017, 29514, 45545)
	...
	recipe:AddLimitedVendor(5175, 1, 49918, 1)
	...
	recipe:SetItemFilterType("ENGINEERING_MATERIALS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(3494, 5174, 5518, 8736, 11017, 11025, 17634, 17637, 18752, 18775, 19576, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 45545)
	...
	recipe:AddTrainer(5174, 5518, 17634, 17637, 18752, 18775, 19576, 25277, 26955, 28697, 33586, 45545)
	...
	recipe:AddTrainer(5174, 5518, 17634, 17637, 18752, 18775, 19576, 25277, 26907, 26955, 26991, 28697, 33586)
	...
	recipe:AddTrainer(5174, 5518, 17634, 17637, 18752, 18775, 19576, 25277, 26907, 26955, 26991, 28697, 33586, 45545)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(3494, 5174, 5518, 8736, 11017, 11025, 17637, 24868, 25099, 25277, 26955, 28697, 33586, 33611, 33634, 45545)
	...
	recipe:SetItemFilterType("ENGINEERING_MOUNT")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(3494, 5174, 5518, 8736, 11017, 11025, 17637, 24868, 25099, 33586, 33611, 33634, 45545)
	...
	recipe:SetSkillLevels(375, 375, 390, 410, 430)
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.RAID, F.IBOP, F.RBOP, F.PALADIN)
	recipe:AddCustom("SUNWELL_RANDOM")
	...
	recipe:SetItemFilterType("ENGINEERING_MATERIALS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(3494, 5174, 5518, 8736, 11017, 11025, 17637, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 45545)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(5174, 11017, 26907, 26955, 29514, 45545)
	...
	recipe:AddTrainer(5174, 5518, 25277, 26907, 26955, 26991, 28697, 33586, 45545)
	...
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(5174, 11017, 25277, 29513, 45545)
	...
	recipe:AddTrainer(5174, 5518, 25277, 26907, 26955)
	...
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOP, F.RBOP)
	recipe:AddTrainer(3494, 5174, 5518, 8736, 11017, 11025, 17637, 25277, 26955, 28697, 33586, 33611, 33634, 45545)
	...
	recipe:AddTrainer(5174, 5518, 11017, 45545)
	...
	recipe:AddTrainer(5174, 5518, 11017)
	...
	recipe:SetItemFilterType("ENGINEERING_MATERIALS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(3494, 5174, 5518, 8736, 11017, 11025, 17637, 33586, 33611, 33634, 45545)
	...
	recipe:SetItemFilterType("ENGINEERING_PET")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(5174, 11017, 29513, 45545)
	...
	recipe:SetItemFilterType("ENGINEERING_PET")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(5174, 7944, 11017, 29514, 45545)
