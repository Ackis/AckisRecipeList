...
function addon:InitEngineering()
	...
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(5174, 5518, 11017, 16726, 17222, 25277, 26907, 26955, 26991, 28697, 33586, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.DRUID, F.ROGUE)
	recipe:AddTrainer(1702, 5174, 5518, 11017, 16726, 17222, 25277, 26907, 26955, 26991, 28697, 33586, 45545, 55143)
