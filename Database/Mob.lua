...
function addon:InitMob()
	...
	-- Southern Barrens
	AddMob(3376,	L["Excavation Raider"],			BZ["Southern Barrens"], 47.8, 88.6)
	AddMob(3377,	L["Bael'dun Soldier"],			BZ["Southern Barrens"], 47.8, 88.6)
	AddMob(3378,	L["Bael'dun Rifleman"],			BZ["Southern Barrens"], 47.8, 88.6)
	AddMob(39153,	L["Bael'dun Officer"],			BZ["Southern Barrens"], 47.8, 88.6)
