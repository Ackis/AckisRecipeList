...
function addon:InitFirstAid(RecipeDB)
	...
	-- Linen Bandage -- 3275
	AddRecipe(3275, 1, 1251, Q.COMMON, GAME_ORIG, 1, 30, 45, 60)
	...
	AddRecipe(3276, 40, 2581, Q.COMMON, GAME_ORIG, 40, 50, 75, 100)
	...
	-- Wool Bandage -- 3277
	AddRecipe(3277, 80, 3530, Q.COMMON, GAME_ORIG, 80, 80, 115, 150)
	...
	AddRecipe(3278, 115, 3531, Q.COMMON, GAME_ORIG, 115, 115, 150, 185)
	...
	-- Silk Bandage -- 7928
	AddRecipe(7928, 150, 6450, Q.COMMON, GAME_ORIG, 150, 150, 180, 210)
	...
	AddRecipe(7929, 180, 6451, Q.COMMON, GAME_ORIG, 180, 180, 210, 240)
	...
	-- Anti-Venom -- 7934
	AddRecipe(7934, 80, 6452, Q.COMMON, GAME_ORIG, 80, 80, 115, 150)
	...
	AddRecipe(7935, 130, 6453, Q.UNCOMMON, GAME_ORIG, 130, 130, 165, 200)
	...
	AddRecipe(10840, 210, 8544, Q.COMMON, GAME_ORIG, 210, 210, 240, 270)
	...
	AddRecipe(10841, 240, 8545, Q.COMMON, GAME_ORIG, 240, 240, 270, 300)
	...
	AddRecipe(18629, 260, 14529, Q.COMMON, GAME_ORIG, 260, 260, 290, 320)
	...
	AddRecipe(18630, 290, 14530, Q.COMMON, GAME_ORIG, 290, 290, 320, 350)
	...
	AddRecipe(23787, 300, 19440, Q.COMMON, GAME_ORIG, 300, 300, 330, 360)
	...
	AddRecipe(27032, 300, 21990, Q.COMMON, GAME_TBC, 300, 330, 347, 365)
	...
	AddRecipe(27033, 330, 21991, Q.COMMON, GAME_TBC, 330, 360, 367, 375)
	...
	AddRecipe(45545, 350, 34721, Q.COMMON, GAME_WOTLK, 350, 375, 392, 410)
	...
	AddRecipe(45546, 400, 34722, Q.UNCOMMON, GAME_WOTLK, 400, 400, 430, 470)
