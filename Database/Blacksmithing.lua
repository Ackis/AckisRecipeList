...
function addon:InitBlacksmithing()
	...
	recipe:AddTrainer(514, 1241, 2836, 2998, 3136, 3174, 3355, 3478, 3557, 4258, 4596, 5511, 6299, 7230, 7231, 11177, 11178, 15400, 16724, 16823, 17245, 33609, 33631, 33675, 37072, 44781, 45548)
	recipe:AddWorldDrop("Eastern Kingdoms", "Kalimdor")
	...
	recipe:AddTrainer(3355, 7230, 7231, 11177, 11178, 26564, 26904, 26952, 26981, 26988, 27034, 28694, 29924, 33591, 37072, 44781, 45548)
	...
	recipe:SetSkillLevels(415, 415, 420, 425, 430)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.RETIRED, F.IBOP, F.RBOP, F.DPS, F.TWO_HAND, F.MACE)
	recipe:AddTrainer(3355, 7230, 7231, 11177, 11178, 37072, 44781, 45548)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(3136, 3355, 4258, 5164, 7230, 7231, 11146, 11177, 11178, 16669, 16823, 26564, 26981, 26988, 28694, 29505, 37072, 44781, 45548)
	...
	recipe:SetSkillLevels(480, 480, 490, 495, 500)
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TRAINER, F.IBOE, F.RBOP)
	recipe:AddTrainer(3136, 3355, 4258, 5164, 7230, 7231, 11146, 11177, 11178, 16669, 16823, 26564, 26981, 26988, 28694, 29505, 44781, 45548)
