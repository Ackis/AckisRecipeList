...
function addon:InitInscription()
	...
	recipe = AddRecipe(86654, 500, 63276, Q.COMMON, V.CATA, 500, 510, 522, 535, nil, "Horde")
	recipe:AddFilters(F.HORDE, F.TRAINER, F.IBOE, F.RBOE)
	recipe:AddTrainer(28702, 30706, 30711, 46716)

	-- Forged Documents -- 89244
	recipe = AddRecipe(89244, 500, 62056, Q.COMMON, V.CATA, 500, 510, 522, 535, nil, "Alliance")
