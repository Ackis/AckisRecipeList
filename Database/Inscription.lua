...
function addon:InitInscription()
	...
	self:AddRecipeFlags(59338, F.ALLIANCE, F.HORDE, F.TRAINER, F.DISC, F.DK, F.IBOE, F.RBOP)
	...
	self:AddRecipeFlags(59339, F.ALLIANCE, F.HORDE, F.TRAINER, F.DISC, F.DK, F.IBOE, F.RBOP)
	...
	self:AddRecipeFlags(59340, F.ALLIANCE, F.HORDE, F.TRAINER, F.DISC, F.DK, F.IBOE, F.RBOP)
